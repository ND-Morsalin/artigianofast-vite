...
const paymentSchema = z.object({
  ...
  paymentMethod: z
    .enum(["credit_card", "paypal", "bank_transfer"] as const, {
...
export default function MobileCheckout() {
  ...
  useEffect(() => {
    ...
    if (pathParts.length >= 5) {
      ...
      if (
        billingTypeParam &&
        (billingTypeParam === "monthly" || billingTypeParam === "yearly")
      ) {
    ...
    async function loadPlanDetails() {
      ...
      try {
        ...
        toast({
          title: "Errore",
          description:
            "Si è verificato un problema durante il caricamento del piano",
          variant: "destructive",
        });
        setLocation("/mobile/subscription-plans");
      } finally {
      ...
      if (response.data) {
        ...
        if (isFreePlan) {
          ...
          toast({
            ...
            description:
              "I dettagli del bonifico sono stati inviati via email. Il tuo abbonamento sarà attivato dopo la verifica del pagamento.",
            duration: 5000,
          });
        } else {
          toast({
  ...
  const isFreePlan =
    planDetails?.isFree || parseFloat(planDetails?.monthlyPrice || "0") === 0;
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <p className="font-medium">
                        €{(parseFloat(getPlanPrice()) * 0.22).toFixed(2)}
                      </p>
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <p className="text-xl font-bold">
                        €{(parseFloat(getPlanPrice()) * 1.22).toFixed(2)}
                      </p>
                    </div>
                  </CardContent>
                </Card>
                        ...
                        <div className="space-y-4 p-4 border rounded-lg bg-slate-50">
                          ...
                          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                            <p className="text-sm text-blue-800">
                              💡 <strong>Usa il form di pagamento</strong>
                              <br />
                              Completa il pagamento usando il form sicuro di
                              Stripe qui sotto
                            </p>
                            <Button
                              type="button"
                              ...
                              onClick={() => {
                                console.log(
                                  "🧪 Testing subscription API directly..."
                                );
                                handleStripePaymentSuccess({
                                  id: "pi_3SLoTD0tBEbSl2OO1uTrh1Zw",
                                  status: "succeeded",
                                });
                              }}
                            >
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input
                                    placeholder="Nome della tua banca"
                                    {...field}
                                  />
                                </FormControl>
                                <FormMessage />
                      ...
                      {watchPaymentMethod === "paypal" && (
                        <div className="p-4 border rounded-lg bg-slate-50">
                          <p className="text-center mb-4">
                            Verrai reindirizzato al sito di PayPal per
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-green-700 mt-1">
                              Questo piano è completamente gratuito. Non sono
                              richiesti dati di pagamento.
                            </p>
                          </div>
                        </div>
                      </div>
