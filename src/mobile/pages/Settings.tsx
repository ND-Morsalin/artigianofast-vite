...
export default function Settings() {
  ...
  const handleSetupComplete = () => {
    ...
    toast({
      ...
      description:
        "La configurazione iniziale è stata completata con successo!",
      variant: "default",
    });
  };
        ...
        <div className="p-4 text-center">
          <div className="flex flex-col items-center space-y-4 py-8">
            ...
            <p className="text-gray-500 text-center max-w-sm">
              Non hai il permesso di visualizzare le impostazioni. Contatta
              l'amministratore per ottenere l'accesso.
            </p>
            <Button
    ...
    <MobileLayout title={t("mobile.settings.title")}>
      ...
      <div className="p-4 pb-20">
          ...
          <CardContent>
            {isProfileLoading ? (
              ...
              <div className="flex items-center space-x-4">
                <div className="shrink-0 bg-blue-600 text-white rounded-full w-14 h-14 flex items-center justify-center text-xl font-semibold">
              ...
              <div className="py-4 text-center">
                <p className="text-gray-500">
                  {t("mobile.profile.loginRequired")}
                </p>
                <Button
                  className="mt-2"
            ...
            {renderSettingItem(
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateSetting("isDarkMode", checked)
                }
              />
            )}
            ...
            <CardContent className="space-y-2">
              <div className="grid grid-cols-2 gap-2">
                <div className="text-sm bg-gray-50 p-2 rounded">
                  ...
                  {getFeatureLimit("maxClients", 10)}
                </div>
                <div className="text-sm bg-gray-50 p-2 rounded">
                  <span className="font-medium">Lavori:</span>{" "}
                  {getFeatureLimit("maxJobs", 50)}
                </div>
                <div className="text-sm bg-gray-50 p-2 rounded">
                  <span className="font-medium">Collaboratori:</span>{" "}
                  {getFeatureLimit("maxCollaborators", 5)}
                </div>
                <div className="text-sm bg-gray-50 p-2 rounded">
                  <span className="font-medium">Storage:</span>{" "}
                  {getFeatureLimit("maxStorage", 5)} GB
                </div>
              </div>
              ...
              <div className="space-y-1 mt-3">
                <div className="flex items-center space-x-2">
                  <div
                    className={`w-2 h-2 rounded-full ${
                      isFeatureEnabled("canUseReports", true)
                        ? "bg-green-500"
                        : "bg-gray-300"
                    }`}
                  />
                ...
                <div className="flex items-center space-x-2">
                  <div
                    className={`w-2 h-2 rounded-full ${
                      isFeatureEnabled("canUseCalendar", true)
                        ? "bg-green-500"
                        : "bg-gray-300"
                    }`}
                  />
                ...
                <div className="flex items-center space-x-2">
                  <div
                    className={`w-2 h-2 rounded-full ${
                      isFeatureEnabled("canAccessMobileApp", true)
                        ? "bg-green-500"
                        : "bg-gray-300"
                    }`}
                  />
                ...
                <div className="flex items-center space-x-2">
                  <div
                    className={`w-2 h-2 rounded-full ${
                      isFeatureEnabled("canUseAutomaticNotifications", false)
                        ? "bg-green-500"
                        : "bg-gray-300"
                    }`}
                  />
                ...
                <div className="flex items-center space-x-2">
                  <div
                    className={`w-2 h-2 rounded-full ${
                      isFeatureEnabled("canUseAI", false)
                        ? "bg-green-500"
                        : "bg-gray-300"
                    }`}
                  />
        ...
        <Card className="mb-6">
          <CardHeader className="pb-2">
            <CardTitle className="text-lg">
              {t("mobile.settings.businessSettings")}
            </CardTitle>
            <CardDescription>
        ...
        >
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Sei sicuro di voler uscire? Dovrai effettuare nuovamente
                l'accesso per utilizzare l'app.
              </DialogDescription>
            </DialogHeader>
