  ...
  const handleSocialSignup = async (provider: "google" | "facebook") => {
    try {
      ...
      toast({
        ...
        description: currentText.socialSignupComingSoon.replace(
          "{provider}",
      ...
      toast({
        title: currentText.socialSignupError.replace(
          "{provider}",
          provider === "google" ? "Google" : "Facebook"
        ),
        description: currentText.socialSignupError.replace(
          "{provider}",
          provider === "google" ? "Google" : "Facebook"
        ),
        variant: "destructive",
