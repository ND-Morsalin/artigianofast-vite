...
export default function Jobs01() {
        ...
        <div className="flex justify-between items-start">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                onClick={() => setLocation(`/mobile/job/${job.id}`)}
              >
                Vedi dettagli
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem
                onClick={() => setLocation(`/mobile/job/${job.id}/edit`)}
              >
                Modifica
              </DropdownMenuItem>
            </DropdownMenuContent>
  ...
  const pageTitle =
    location === "/mobile/registration" ? "Registrazioni" : "Lavori";
