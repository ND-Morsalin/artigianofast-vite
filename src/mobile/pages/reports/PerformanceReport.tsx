...
export default function PerformanceReport() {
  ...
  const getTimeframeTitle = () => {
    switch (filters.timeframe) {
      case "day":
        return t("mobile.reports.filters.day");
      case "week":
        return t("mobile.reports.filters.week");
      case "month":
        return t("mobile.reports.filters.month");
      case "quarter":
        return t("mobile.reports.filters.quarter");
      case "year":
        return t("mobile.reports.filters.year");
      case "custom":
        if (filters.startDate && filters.endDate) {
          return `${t("mobile.reports.filters.startDate")}: ${format(
            filters.startDate,
            "dd/MM/yyyy"
          )} - ${t("mobile.reports.filters.endDate")}: ${format(
            filters.endDate,
            "dd/MM/yyyy"
          )}`;
        }
      ...
      default:
        return t("mobile.reports.performanceReport.title");
    }
  };
  ...
  const costChartData = [
    {
      name: t("mobile.reports.performanceReport.materials"),
      value: costData.materials,
    },
    {
      name: t("mobile.reports.performanceReport.labor"),
      value: costData.labor,
    },
    {
      name: t("mobile.reports.performanceReport.totalCosts"),
      value: costData.total - costData.materials - costData.labor,
    },
  ];
  ...
  const kpiTableData = [
    {
      name: t("mobile.reports.performanceReport.performanceScore"),
      value: performanceData.score,
      target: 85,
      unit: "%",
    },
    {
      name: t("mobile.reports.performanceReport.onTimeCompletion"),
      value: performanceData.onTimeCompletion,
      target: 90,
      unit: "%",
    },
    {
      name: t("mobile.reports.performanceReport.clientSatisfaction"),
      value: performanceData.clientSatisfaction,
      target: 85,
      unit: "%",
    },
    {
      name: t("mobile.reports.performanceReport.efficiency"),
      value: timeData.efficiency,
      target: 80,
      unit: "%",
    },
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <DashboardMetricCard
            ...
            trendLabel={
              t("mobile.reports.metrics.vs") +
              " " +
              t("mobile.reports.metrics.previous")
            }
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <PerformanceGauge
            ...
            value={performanceData.onTimeCompletion}
            indicator={
              performanceData.onTimeCompletion >= 80
                ? "green"
                : performanceData.onTimeCompletion >= 60
                ? "yellow"
                : "red"
            }
          ...
          <PerformanceGauge
            ...
            value={performanceData.clientSatisfaction}
            indicator={
              performanceData.clientSatisfaction >= 80
                ? "green"
                : performanceData.clientSatisfaction >= 60
                ? "yellow"
                : "red"
            }
            description={t(
              "mobile.reports.performanceReport.clientSatisfaction"
            )}
          />
        </div>
