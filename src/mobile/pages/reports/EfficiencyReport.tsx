...
export default function EfficiencyReport() {
  ...
  const getTimeframeTitle = () => {
    switch (filters.timeframe) {
      ...
      default:
        return t("mobile.reports.efficiencyReport.title");
    }
  };
  ...
  const topProcessesData = [
    ...
    {
      id: 3,
      name: "Manutenzione Condizionatori",
      efficiency: 93,
      status: "ottimizzato",
    },
    {
      id: 4,
      name: "Preventivo e Sopralluogo",
      efficiency: 87,
      status: "standard",
    },
  ];
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <DashboardMetricCard
                ...
                trendLabel={
                  ...
                  " " +
                  t("mobile.reports.metrics.period")
                }
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start gap-3 p-3 bg-amber-50 rounded-md">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600">
                        Il tempo di attesa tra le fasi di riparazione è
                        superiore alla media. Una migliore pianificazione può
                  ...
                  <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-md">
                    ...
                    <div>
                      <h4 className="font-medium text-sm">
                        Standardizza i processi di installazione
                      </h4>
                      <p className="text-xs text-gray-600">
                        Creare procedure standard per le installazioni più
                        comuni può aumentare l'efficienza del 15%.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-green-50 rounded-md">
                    ...
                    <div>
                      <h4 className="font-medium text-sm">
                        Ottimizzazione ottenuta: Manutenzioni
                      </h4>
                      <p className="text-xs text-gray-600">
                        Il processo di manutenzione programmata ha raggiunto
                        un'efficienza superiore al 90%. Continua così!
                      </p>
                    </div>
                  </div>
                </div>
