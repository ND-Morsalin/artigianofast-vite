...
export default function FinancialReport() {
  ...
  const getTimeframeTitle = () => {
    switch (filters.timeframe) {
      ...
      default:
        return t("mobile.reports.financialReport.title");
    }
  };
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 gap-6 mb-8">
              ...
              <ReportChartCard
                title={
                  t("mobile.reports.financialReport.totalRevenue") +
                  " & " +
                  t("mobile.reports.financialReport.totalCosts")
                }
            ...
            <Card className="mb-8">
              <CardHeader>
                <CardTitle className="text-lg">
                  {t("mobile.reports.financialReport.topClients")}
                </CardTitle>
              </CardHeader>
              <CardContent className="overflow-x-auto">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead>
                        {t("mobile.reports.financialReport.client")}
                      </TableHead>
                      <TableHead className="text-right">
                        {t("mobile.reports.financialReport.jobs")}
                      </TableHead>
                      <TableHead className="text-right">
                        {t("mobile.reports.financialReport.revenue")}
                      </TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
