  ...
  const rightAction = (
    <Button
      ...
      disabled={
        !canManageClients ||
        clients.length >=
          (getLimit("max_clients", -1) === -1
            ? Infinity
            : getLimit("max_clients", 0))
      }
      title={
        !canManageClients ? "Funzionalità non disponibile nel piano" : undefined
      }
    >
            ...
            {filteredClients.map((client) => (
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex items-center space-x-2">
                    <Button
                      ...
                      size="icon"
                      onClick={() =>
                        setLocation(`/mobile/settings/clients/${client.id}`)
                      }
                    >
                ...
                <div className="mt-2 text-sm text-gray-500 space-y-1">
                  {client.email && (
                    <p className="flex items-center">Email: {client.email}</p>
                  )}
                  {client.phone && (
          ...
          <div className="py-8 text-center">
            ...
            {clients.length >=
              ...
              <div className="mt-2 text-xs text-amber-700">
                Hai raggiunto il limite massimo di clienti del tuo piano.
              </div>
            )}
          </div>
        )}
