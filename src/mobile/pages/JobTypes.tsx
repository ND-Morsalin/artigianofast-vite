...
export default function JobTypesSettings() {
  ...
  const handleDeleteClick = (id: number, name: string) => {
    if (
      window.confirm(
        `Sei sicuro di voler eliminare il tipo di lavoro "${name}"?`
      )
    ) {
              ...
              >
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <div className="flex items-center mt-1 space-x-2">
                      <Badge
                        className={getSectorColor(jobType.sector || "altro")}
                      >
                  ...
                  <div className="flex items-center space-x-2">
                    <Button
                      ...
                      size="icon"
                      onClick={() =>
                        setLocation(`/mobile/settings/jobtypes/${jobType.id}`)
                      }
                    >
                    ...
                    <Button
                      ...
                      size="icon"
                      onClick={() =>
                        handleDeleteClick(jobType.id, jobType.name)
                      }
                    >
                ...
                <div className="mt-2 text-xs text-gray-400">
                  {jobType.defaultPrice && (
                    <span className="mr-3">
                      Prezzo base: €{jobType.defaultPrice.toFixed(2)}
                    </span>
                  )}
