...
export default function MobileSubscriptionPlans() {
    ...
    async function loadPlans() {
      try {
        ...
        toast({
          title: "Errore",
          description:
            "Si è verificato un problema durante il caricamento dei piani",
          variant: "destructive",
        });
      } finally {
        setLoading(false);
  ...
  const getFeatures = (plan: SubscriptionPlan): string[] => {
    ...
    try {
      ...
      console.log("Errore nel parsing delle funzionalità:", e);
      try {
  ...
  const handleSubscribe = async () => {
    ...
    try {
      ...
      // Log per debug
      console.log(
        `Reindirizzamento al checkout: /checkout/${selectedPlan}/${billingType}`
      );
      ...
      console.log(
        "Piano a pagamento selezionato, reindirizzamento al checkout"
      );
      ...
      toast({
        ...
        description:
          error instanceof Error
            ? error.message
            : "Si è verificato un problema nella selezione del piano",
        variant: "destructive",
      });
