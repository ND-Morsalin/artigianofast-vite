...
//         <p className="mb-4">
//           Questa è la pagina per le registrazioni delle attività.
//         </p>
...
export default function MobileApp() {
  ...
  console.log(
    "🚨 FORCE RELOAD: MobileApp.tsx loaded at:",
  ...
  // const getActiveTab = () => {
  //   if (location === "/mobile" || location === "/mobile/dashboard")
  //     return "dashboard";
  //   if (location === "/mobile/calendar") return "calendar";
  //   if (location.startsWith("/mobile/jobs") || location === "/mobile/new-job")
  //     return "jobs";
  //   if (
  //     location.startsWith("/mobile/registration") ||
  //     location === "/mobile/jobs01"
  //   )
  //     return "jobRegistration";
  //   if (location.startsWith("/mobile/settings")) return "settings";
  //   if (
  //     location === "/mobile/report" ||
  //     location.startsWith("/mobile/reports/")
  //   )
  //     return "report";
  //   return "";
  // };
        ...
        <div className="min-h-screen bg-white flex flex-col">
          <div className="flex-1 overflow-auto">
            <Switch>
              ...
              <Route
                path="/mobile/subscription-plans"
                component={MobileSubscriptionPlans}
              />
              <Route
                path="/mobile/checkout/:planId?/:billingType?"
              ...
              />
              <Route
                path="/mobile/settings/clients/new"
                component={ClientForm}
              />
              <Route
                path="/mobile/settings/clients/:id"
                component={ClientForm}
              />
              <Route
                path="/mobile/settings/jobtypes"
                component={JobTypesSettings}
              />
              <Route
                path="/mobile/settings/jobtypes/new"
                component={JobTypeForm}
              />
              <Route
                path="/mobile/settings/jobtypes/:id"
                component={JobTypeForm}
              />
              <Route
              ...
              />
              <Route
                path="/mobile/settings/activities/new"
                component={ActivityForm}
              />
              <Route
                path="/mobile/settings/activities/:id"
                component={ActivityForm}
              />
              <Route path="/mobile/settings/roles" component={RolesSettings} />
              <Route
                path="/mobile/settings/roles/new"
                component={RoleFormPage}
              />
              <Route
                path="/mobile/settings/roles/:id"
                component={RoleFormPage}
              />
              <Route
                path="/mobile/settings/collaborators"
                component={CollaboratorsSettings}
              />
              <Route
                path="/mobile/settings/collaborators/new"
                component={CollaboratorFormPage}
              />
              <Route
                path="/mobile/settings/collaborators/:id"
                component={CollaboratorFormPage}
              />
              <Route path="/mobile/settings/notifications">
