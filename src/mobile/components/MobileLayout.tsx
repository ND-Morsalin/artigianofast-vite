                ...
                <SheetContent side="left">
                  <div className="flex flex-col h-full">
                    ...
                    <div className="flex-1 py-4 space-y-1">
                      <Button
                        variant={
                          isActive("/mobile/dashboard") ? "default" : "ghost"
                        }
                      ...
                      <Button
                        variant={
                          isActive("/mobile/calendar") ? "default" : "ghost"
                        }
                        className="w-full justify-start"
                      ...
                      <Button
                        variant={
                          isActive("/mobile/report") ||
                          isActive("/mobile/stats")
                            ? "default"
                            : "ghost"
                        }
                        className="w-full justify-start"
                      ...
                      <Button
                        variant={
                          isActive("/mobile/profile") ? "default" : "ghost"
                        }
                        className="w-full justify-start"
                      ...
                      <Button
                        variant={
                          isActive("/mobile/settings") ? "default" : "ghost"
                        }
                        className="w-full justify-start"
