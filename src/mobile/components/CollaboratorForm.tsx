...
export default function CollaboratorForm() {
  ...
  const form = useForm<CollaboratorFormValues>({
    resolver: zodResolver(
      collaboratorSchema
    ) as unknown as Resolver<CollaboratorFormValues>,
    defaultValues: {
      name: "",
      email: "",
      phone: "",
  ...
  const processRoleIds = (
    roleIdsString: string | undefined | null
  ): string[] => {
  ...
  const updateMutation = useMutation({
    mutationFn: async (values: CollaboratorFormValues) => {
      ...
      try {
        console.log(
          "Dati collaboratore da aggiornare:",
          JSON.stringify(values, null, 2)
        );
  ...
  return (
    <MobileLayout
      title={
        isEditMode
          ? t("mobile.forms.collaborator.editTitle")
          : t("mobile.forms.collaborator.title")
      }
      showBackButton={true}
      rightAction={
        <Button
          variant="ghost"
          size="icon"
          onClick={() => setLocation("/mobile/settings/collaborators")}
        >
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder={t(
                          "mobile.forms.collaborator.namePlaceholder"
                        )}
                        {...field}
                      />
                    </FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {t("mobile.forms.collaborator.email")}
                    </FormLabel>
                    <FormControl>
                      <Input
                        placeholder={t(
                          "mobile.forms.collaborator.emailPlaceholder"
                        )}
                        type="email"
                        {...field}
                        value={field.value || ""}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {t("mobile.forms.collaborator.phone")}
                    </FormLabel>
                    <FormControl>
                      <Input
                        placeholder={t(
                          "mobile.forms.collaborator.phonePlaceholder"
                        )}
                        {...field}
                        value={field.value || ""}
                      />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {t("mobile.forms.collaborator.roles")}
                    </FormLabel>
                    <MultiSelect
                      ...
                      placeholder={t(
                        "mobile.forms.collaborator.rolesPlaceholder"
                      )}
                    />
                    <FormDescription>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input
                    placeholder={t(
                      "mobile.forms.collaborator.skillsPlaceholder"
                    )}
                    value={newSkill}
              ...
              <div className="space-y-4">
                    ...
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                      <div className="space-y-0.5">
                        <FormLabel className="text-base">
                          {t("mobile.forms.collaborator.notifyByEmail")}
                        </FormLabel>
                        <FormDescription>
                          {t(
                            "mobile.forms.collaborator.notifyByEmailDescription"
                          )}
                        </FormDescription>
                      </div>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                      <div className="space-y-0.5">
                        <FormLabel className="text-base">
                          {t("mobile.forms.collaborator.notifyByWhatsApp")}
                        </FormLabel>
                        <FormDescription>
                          {t(
                            "mobile.forms.collaborator.notifyByWhatsAppDescription"
                          )}
                        </FormDescription>
                      </div>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("mobile.forms.collaborator.notificationTime")}
                      </FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                      ...
                      <FormDescription>
                        {t(
                          "mobile.forms.collaborator.notificationTimeDescription"
                        )}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                      <div className="space-y-0.5">
                        <FormLabel className="text-base">
                          {t("mobile.forms.collaborator.canEditRegistrations")}
                        </FormLabel>
                        <FormDescription>
                          {t(
                            "mobile.forms.collaborator.canEditRegistrationsDescription"
                          )}
                        </FormDescription>
                      </div>
                      <FormControl>
              ...
              <Button type="submit" className="w-full" disabled={isSaving}>
                ...
                {isEditMode
                  ? t("mobile.forms.collaborator.updateButton")
                  : t("mobile.forms.collaborator.createButton")}
              </Button>
            </form>
          </Form>
        )}
