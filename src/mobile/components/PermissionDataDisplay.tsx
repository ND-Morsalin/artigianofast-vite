...
import type { MobilePermissions } from "../contexts/PermissionContext";
...
export const PermissionClientDisplay: React.FC<{
  ...
  <PermissionDataDisplay data={client} dataType="client" fallback={fallback}>
    {children}
...
export const PermissionJobDisplay: React.FC<{
  ...
  <PermissionDataDisplay data={job} dataType="job" fallback={fallback}>
    {children}
  </PermissionDataDisplay>
);
...
export const PermissionInvoiceDisplay: React.FC<{
  ...
  <PermissionDataDisplay data={invoice} dataType="invoice" fallback={fallback}>
    {children}
  </PermissionDataDisplay>
);
...
export const PermissionReportDisplay: React.FC<{
  ...
  <PermissionDataDisplay data={report} dataType="report" fallback={fallback}>
    {children}
  </PermissionDataDisplay>
);
/**
...
export const FinancialDataDisplay: React.FC<{
  ...
  const canViewFinancials =
    hasPermission("canViewJobFinancials") ||
