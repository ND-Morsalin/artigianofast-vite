...
export default function JobTypeForm() {
  ...
  // apply fetched data to the form when available
  useEffect(() => {
    if (data) {
      form.reset(data as JobTypeFormValues);
    }
  }, [data, form]);
  ...
  const createJobType = useMutation({
    ...
    onError: (error: Error) => {
      ...
      toast({
        ...
        description:
          error.message ||
          "Si è verificato un errore durante la creazione del tipo di lavoro",
        variant: "destructive",
      });
    },
  });
  ...
  const updateJobType = useMutation({
    ...
    onError: (error: Error) => {
      ...
      toast({
        ...
        description:
          error.message ||
          "Si è verificato un errore durante l'aggiornamento del tipo di lavoro",
        variant: "destructive",
      });
    },
  });
