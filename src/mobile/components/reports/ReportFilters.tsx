...
export default function ReportFilters({ onApplyFilters }: ReportFiltersProps) {
  ...
  const formatDateRange = () => {
    if (filters.startDate && filters.endDate) {
      return `${format(filters.startDate, "dd/MM/yyyy")} - ${format(
        filters.endDate,
        "dd/MM/yyyy"
      )}`;
    }
      ...
      <Card className="mb-6">
        <CardContent className="p-4">
                ...
                <div className="mt-6 space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleFilterChange("clientType", value)
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleFilterChange("collaborator", value)
                      }
                    >
                      <SelectTrigger>
                      ...
                      <SelectContent>
                        <SelectItem value="">Tutti</SelectItem>
                        {filterOptions.collaborators?.map(
                          (collaborator: any) => (
                            <SelectItem
                              key={collaborator.id}
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            {filters.jobType &&
              filterOptions.jobTypes?.find(
                (t: any) => t.id.toString() === filters.jobType
              ) && (
            ...
            {filters.activityType &&
              filterOptions.activities?.find(
                (t: any) => t.id.toString() === filters.activityType
              ) && (
                <div className="bg-blue-600/10 text-primary text-xs py-1 px-2 rounded-full">
                  Attività:{" "}
                  {
            ...
            {filters.clientType &&
              filterOptions.clientTypes?.find(
                (t: any) => t.value === filters.clientType
              ) && (
                <div className="bg-blue-600/10 text-primary text-xs py-1 px-2 rounded-full">
                  Tipo cliente:{" "}
                  {
            ...
            {filters.client &&
              filterOptions.clients?.find(
                (c: any) => c.id.toString() === filters.client
              ) && (
                <div className="bg-blue-600/10 text-primary text-xs py-1 px-2 rounded-full">
                  Cliente:{" "}
                  {
            ...
            {filters.collaborator &&
              filterOptions.collaborators?.find(
                (c: any) => c.id.toString() === filters.collaborator
              ) && (
                <div className="bg-blue-600/10 text-primary text-xs py-1 px-2 rounded-full">
                  Collaboratore:{" "}
                  {
