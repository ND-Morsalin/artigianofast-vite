...
const clientSchema = z.object({
  ...
  type: z.enum(["residential", "commercial", "industrial"], {
    error: "Il tipo di cliente è richiesto",
  }),
...
export default function ClientForm() {
  ...
  return (
    <MobileLayout
      title={
        isEditMode
          ? t("mobile.forms.client.editTitle")
          : t("mobile.forms.client.title")
      }
      rightAction={
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder={t("mobile.forms.client.namePlaceholder")}
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
                    ...
                    >
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue
                            placeholder={t(
                              "mobile.forms.client.typePlaceholder"
                            )}
                          />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
                        <SelectItem value="residential">
                          {t("mobile.forms.client.typeOptions.residential")}
                        </SelectItem>
                        <SelectItem value="commercial">
                          {t("mobile.forms.client.typeOptions.commercial")}
                        </SelectItem>
                        <SelectItem value="industrial">
                          {t("mobile.forms.client.typeOptions.industrial")}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                    <FormMessage />
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder={t(
                          "mobile.forms.client.addressPlaceholder"
                        )}
                        {...field}
                      />
                    </FormControl>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder={t(
                            "mobile.forms.client.phonePlaceholder"
                          )}
                          {...field}
                        />
                      </FormControl>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder={t(
                            "mobile.forms.client.emailPlaceholder"
                          )}
                          {...field}
                        />
                      </FormControl>
            ...
            {hasPermission("canViewClientGeoLocation") && (
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {t("mobile.forms.client.geoLocation")}
                    </FormLabel>
                    <div className="flex gap-2">
                      <FormControl>
                        <Input
                          placeholder={t(
                            "mobile.forms.client.geoLocationPlaceholder"
                          )}
                          {...field}
                        />
                      </FormControl>
                          ...
                          if (navigator.geolocation) {
                            navigator.geolocation.getCurrentPosition(
                              (position) => {
                                ...
                                toast({
                                  title: t(
                                    "mobile.forms.client.locationSuccess"
                                  ),
                              ...
                              (error) => {
                                toast({
                                  title: "Errore",
                                  description: t(
                                    "mobile.forms.client.locationError"
                                  ),
                                  variant: "destructive",
                                });
                            ...
                            toast({
                              title: "Errore",
                              description: t(
                                "mobile.forms.client.geolocationNotSupported"
                              ),
                              variant: "destructive",
                            });
                          }
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder={t("mobile.forms.client.notesPlaceholder")}
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
            ...
            <div className="flex justify-end space-x-2 pt-4">
              ...
              <Button type="submit" disabled={isSaving || isLoading}>
                {isSaving
                  ? t("mobile.forms.client.savingButton")
                  : isEditMode
                  ? t("mobile.forms.client.updateButton")
                  : t("mobile.forms.client.saveButton")}
              </Button>
            </div>
          </form>
        </Form>
