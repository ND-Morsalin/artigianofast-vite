...
console.log("ClientListExample permissions:", hasPermission);
  const clients = [
    {
      id: 1,
      name: "Famiglia Bianchi",
      email: "bianchi@email.com",
      phone: "+39 123 456 789",
      address: "Via Roma 123",
      financialInfo: { creditLimit: 5000, paymentTerms: "30 days" },
    },
    {
      id: 2,
      name: "Ufficio Rossi",
      ...
      financialInfo: { creditLimit: 10000, paymentTerms: "15 days" },
    },
  ];
...
export const JobDetailsExample: React.FC = () => {
  ...
  console.log("JobDetailsExample permissions:", hasPermission);
...
export const DashboardExample: React.FC = () => {
  const { hasPermission } = usePermissions();
console.log("DashboardExample permissions:", hasPermission);
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <PermissionGate permission="canViewFinancialReports">
          <div className="bg-white p-4 rounded-lg shadow border">
            ...
            <FinancialDataDisplay amount={15420.5} />
