  ...
  const handleSocialLogin = async (provider: "google" | "facebook") => {
    try {
      ...
      toast({
        ...
        description: currentText.socialLoginComingSoon.replace(
          "{provider}",
      ...
      toast({
        title: "Errore",
        description: currentText.socialLoginError.replace(
          "{provider}",
          provider === "google" ? "Google" : "Facebook"
        ),
        variant: "destructive",
  ...
  const onSubmit = async (data: LoginFormValues) => {
    try {
      ...
      toast({
        ...
        description:
          err instanceof Error ? err.message : currentText.loginError,
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
  ...
  const textContent = {
    it: {
      ...
      socialLoginComingSoon:
        "L'accesso con {provider} sarà disponibile a breve",
      socialLoginError:
        "Non è stato possibile effettuare l'accesso con {provider}",
