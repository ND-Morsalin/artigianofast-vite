...
export default function ArtisanDashboard() {
  ...
  const currentPlan = userSubscription
    ? subscriptionPlans?.find(
        (plan: any) => plan.id === userSubscription.planId
      )
    : null;
  ...
  const enabledFeatures = currentPlan
    ? Object.keys(planFeatures).filter(
        (key) => key !== "permissions" && planFeatures[key] === true
      )
    : [];
  ...
  const realStats = {
    ...
    completedJobs: jobsError
      ? 0
      : jobs?.filter((job: any) => job.status === "completed")?.length || 0,
    monthlyRevenue: invoicesError
      ? 0
      : invoices
          ?.filter((invoice: any) => {
    ...
    pendingInvoices: invoicesError
      ? 0
      : invoices?.filter((invoice: any) => invoice.status === "pending")
          ?.length || 0,
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button
              variant="outline"
              onClick={() => setLocation("/artisan/logout")}
            >
              {t("common.logout")}
            </Button>
          </div>
          ...
          <Card className="mb-6">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                {t("artisanDashboard.currentPlan")}:{" "}
                {currentPlan.name ||
                  `Plan ${userSubscription?.planId || "Unknown"}`}
              </CardTitle>
              <CardDescription>
                {currentPlan.description ||
                  t("artisanDashboard.planForSmallBusinesses")}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                <div>
                  <p className="font-medium">
                    {t("artisanDashboard.monthlyPrice")}
                  </p>
                  <p className="text-gray-600">€{currentPlan.monthlyPrice}</p>
                </div>
                <div>
                  <p className="font-medium">
                    {t("artisanDashboard.annualPrice")}
                  </p>
                ...
                <div>
                  ...
                  >
                    {currentPlan.isActive
                      ? t("artisanDashboard.active")
                      : t("artisanDashboard.inactive")}
                  </Badge>
                </div>
                <div>
                  ...
                  <Badge variant={currentPlan.isFree ? "outline" : "default"}>
                    {currentPlan.isFree
                      ? t("artisanDashboard.free")
                      : t("artisanDashboard.paid")}
                  </Badge>
                </div>
              </div>
              ...
              <div className="mt-4 pt-4 border-t">
                <p className="font-medium mb-2">
                  {t("artisanDashboard.enabledFeatures")}:
                </p>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-2 text-yellow-800">
                ...
                <span className="font-medium">
                  {t("artisanDashboard.noActivePlan")}
                </span>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">
                  {t("artisanDashboard.totalClients")}
                </CardTitle>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {clientsLoading
                    ? t("common.loading")
                    : `+2 ${t("artisanDashboard.thisMonth")}`}
                </p>
              </CardContent>
            </Card>
          )}
          ...
          {canManageInvoices && (
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">
                  {t("artisanDashboard.monthlyRevenue")}
                </CardTitle>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {invoicesLoading
                    ? t("common.loading")
                    : `+12% ${t("artisanDashboard.comparedToLastMonth")}`}
                </p>
              </CardContent>
            </Card>
          )}
          ...
          {canManageCollaborators && (
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">
                  {t("artisanDashboard.collaboratorsActive")}
                </CardTitle>
                ...
                >
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-sm text-gray-500">
                      {t("artisanDashboard.manageClients")}
                    </p>
                  </CardContent>
                </Card>
              )}
              ...
              {canManageCollaborators && (
                ...
                >
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="font-medium">
                      {t("artisanDashboard.collaborators")}
                    </p>
                    <p className="text-sm text-gray-500">
                      {t("artisanDashboard.manageTeam")}
                    </p>
                  </CardContent>
                </Card>
              )}
              ...
              {canManageInvoices && (
                ...
                >
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="font-medium">
                      {t("artisanDashboard.invoices")}
                    </p>
                    <p className="text-sm text-gray-500">
                      {t("artisanDashboard.manageInvoicing")}
                    </p>
                  </CardContent>
                </Card>
              )}
              ...
              {canViewCalendar && (
                ...
                >
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="font-medium">
                      {t("artisanDashboard.calendar")}
                    </p>
                    <p className="text-sm text-gray-500">
                      {t("artisanDashboard.scheduleActivities")}
                    </p>
                  </CardContent>
                </Card>
              )}
              ...
              {canViewReports && (
                ...
                >
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="font-medium">
                      {t("artisanDashboard.reports")}
                    </p>
                    <p className="text-sm text-gray-500">
                      {t("artisanDashboard.analyticsAndStats")}
                    </p>
                  </CardContent>
                </Card>
              )}
              ...
              {canViewSettings && (
                ...
                >
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="font-medium">
                      {t("artisanDashboard.settings")}
                    </p>
                    <p className="text-sm text-gray-500">
                      {t("artisanDashboard.configureSystem")}
                    </p>
                  </CardContent>
                </Card>
              )}
                      ...
                      {recentJobs.map((job: any) => (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            >
                              {job.status === "completed"
                                ? t("jobs.statuses.completed")
                                : job.status === "in_progress"
                                ? t("jobs.statuses.in_progress")
                                : job.status === "scheduled"
                                ? t("jobs.statuses.scheduled")
                                : job.status === "active"
                                ? t("jobs.statuses.active")
                                : job.status === "pending"
                            ...
                            >
                              {job.priority === "high"
                                ? t("jobs.priorities.high")
                                : job.priority === "medium"
                                ? t("jobs.priorities.medium")
                                : t("jobs.priorities.low")}
                            </Badge>
                          </div>
                        </div>
                      ))}
                        ...
                        >
                          ...
                          <Badge variant="outline">
                            {client.type === "residential"
                              ? t("clients.types.residential")
                              : client.type === "commercial"
                              ? t("clients.types.commercial")
                              : client.type === "industrial"
                              ? t("clients.types.industrial")
                              : client.type || "Unknown"}
                          </Badge>
                        </div>
                      ))}
