  ...
  const onSubmit = async (data: ForgotPasswordFormValues) => {
    ...
    try {
      ...
      toast({
        title: "Email inviata",
        description:
          "Se l'email esiste, riceverai istruzioni per reimpostare la password",
      });
    } catch (error) {
      console.log(error);
      ...
      <Card className="w-full max-w-md">
          ...
          {emailSent ? (
            <Alert className="bg-green-50 border-green-200">
              ...
              <AlertDescription className="text-green-700">
                Abbiamo inviato le istruzioni per reimpostare la password
                all'indirizzo email fornito. Controlla la tua casella di posta
        ...
        <CardFooter className="flex flex-col">
          <p className="text-xs text-center text-gray-500 mt-4">
            Riceverai un'email con le istruzioni per reimpostare la tua
            password.
            <br />
