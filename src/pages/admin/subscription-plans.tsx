    ...
    <div className="container mx-auto py-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t("admin.plans.description")}</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-10">
              <p className="text-gray-500 mb-4">
                {t("admin.plans.noPlansAvailable")}
              </p>
              <Button
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder={t("admin.plans.planName")}
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {t("admin.plans.features")} (formato JSON)
                    </FormLabel>
                    <FormControl>
                      <Textarea
