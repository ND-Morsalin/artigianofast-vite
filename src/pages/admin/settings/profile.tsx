...
const companyProfileSchema = z.object({
  ...
  owner: z
    .string()
    .min(2, "Il nome del proprietario deve contenere almeno 2 caratteri"),
  vatNumber: z
    .string()
    .min(5, "La partita IVA deve contenere almeno 5 caratteri"),
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("admin.profile.form.companyName")}
                        </FormLabel>
                        <FormControl>
                          <Input
                            placeholder={t(
                              "admin.profile.form.companyNamePlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder={t(
                              "admin.profile.form.ownerPlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("admin.profile.form.vatNumber")}
                        </FormLabel>
                        <FormControl>
                          <Input
                            placeholder={t(
                              "admin.profile.form.vatNumberPlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            type="email"
                            placeholder={t(
                              "admin.profile.form.emailPlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder={t(
                              "admin.profile.form.phonePlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder={t(
                              "admin.profile.form.websitePlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder={t(
                              "admin.profile.form.addressPlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder={t(
                              "admin.profile.form.cityPlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("admin.profile.form.postalCode")}
                        </FormLabel>
                        <FormControl>
                          <Input
                            placeholder={t(
                              "admin.profile.form.postalCodePlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("admin.profile.form.province")}
                        </FormLabel>
                        <FormControl>
                          <Input
                            placeholder={t(
                              "admin.profile.form.provincePlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder={t(
                              "admin.profile.form.countryPlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("admin.profile.form.invoicePrefix")}
                        </FormLabel>
                        <FormControl>
                          <Input
                            placeholder={t(
                              "admin.profile.form.invoicePrefixPlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            type="number"
                            placeholder={t(
                              "admin.profile.form.taxRatePlaceholder"
                            )}
                            {...field}
                            onChange={(e) =>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <MultiSelect
                          ...
                          placeholder={t(
                            "admin.profile.form.sectorsPlaceholder"
                          )}
                        />
                      </FormControl>
                      <FormDescription>
                        Seleziona i settori in cui opera la tua azienda. Questo
                        determinerà le attività e i tipi di lavoro disponibili.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
