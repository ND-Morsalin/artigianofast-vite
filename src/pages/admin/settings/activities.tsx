...
export default function AdminActivitiesPage() {
  ...
  const form = useForm<ActivityFormValues>({
    resolver: zodResolver(
      activitySchema
    ) as unknown as Resolver<ActivityFormValues>,
    defaultValues: {
      name: "",
      description: "",
      implementationNotes: "",
  ...
  const getJobTypeName = (id: number) => {
    if (!Array.isArray(jobTypes))
      return `${t("admin.activities.table.jobTypes")} #${id}`;
    const jobType = jobTypes.find((jt: any) => jt.id === id);
    return jobType
      ? jobType.name
      : `${t("admin.activities.table.jobTypes")} #${id}`;
  };
          ...
          {isLoadingActivities ? (
            ...
            <div className="flex flex-col items-center justify-center py-10">
              <p className="text-gray-500 mb-4">
                {t("activities.noActivitiesAvailable")}
              </p>
              <Button
                ...
                {Array.isArray(activities) &&
                  activities.map((activity: any) => (
                    <TableRow key={activity.id}>
                      ...
                      <TableCell>
                        {getJobTypeBadges(activity.jobTypeIds) ||
                          t("admin.activities.table.noJobTypes")}
                      </TableCell>
                      <TableCell>
                        {getSectorBadges(activity.sectorIds) ||
                          t("admin.activities.table.noSectors")}
                      </TableCell>
                      <TableCell>
                        {activity.defaultDuration
                          ? `${activity.defaultDuration} ${t(
                              "admin.activities.table.hours"
                            )}`
                          : "-"}
                      </TableCell>
                      <TableCell>
                        ...
                        >
                          {activity.isDefault
                            ? t("admin.activities.table.yes")
                            : t("admin.activities.table.no")}
                        </span>
                      </TableCell>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        ...
                        >
                          <option value="">
                            {t("activities.form.mainJobTypePlaceholder")}
                          </option>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("activities.form.defaultDuration")}
                      </FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          step="0.5"
                          placeholder={t(
                            "activities.form.defaultDurationPlaceholder"
                          )}
                          {...field}
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          step="0.01"
                          placeholder={t(
                            "activities.form.defaultRatePlaceholder"
                          )}
                          {...field}
                          value={field.value === null ? "" : field.value}
                          onChange={(e) => {
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          step="0.01"
                          placeholder={t(
                            "activities.form.defaultCostPlaceholder"
                          )}
                          {...field}
                          value={field.value === null ? "" : field.value}
                          onChange={(e) => {
                      ...
                      <FormControl>
                        <MultiSelect
                          ...
                          onPrimaryChange={(primary) =>
                            form.setValue("jobTypeId", primary)
                          }
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {t("activities.form.implementationNotes")}
                    </FormLabel>
                    <FormControl>
                      <Textarea
                        placeholder={t(
                          "activities.form.implementationNotesPlaceholder"
                        )}
                        {...field}
                        value={field.value || ""}
                      />
