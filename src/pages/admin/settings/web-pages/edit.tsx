...
const formSchema = z.object({
  ...
  slug: z
    ...
    .max(100, "Lo slug non può superare i 100 caratteri")
    .regex(
      /^[a-z0-9-]+$/,
...
export default function EditWebPage(props: { params: { id: string } }) {
  const [, navigate] = useLocation();
  const pageId = props.params?.id ? parseInt(props.params.id) : null;
  ...
  type WebPage = z.infer<typeof formSchema> & { id: number };
  ...
  // Aggiorna il form quando i dati sono disponibili
  useEffect(() => {
    if (page) {
      form.reset({
        title: page.title,
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-gray-500">
              Modifica i dettagli della pagina web
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-2">
          <Button variant="outline" asChild>
            <a
              href={`/${page?.type === "mobile" ? "mobile/" : ""}${page?.slug}`}
              target="_blank"
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Sei sicuro di voler eliminare questa pagina? Questa azione non
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>
                        Se attivato, questa pagina sarà l'homepage per il tipo
                        selezionato (desktop o mobile)
                      </FormDescription>
                    </div>
                    <FormControl>
                      <Switch
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Il titolo che verrà mostrato nei motori di ricerca (se
                      vuoto, verrà usato il titolo della pagina)
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
