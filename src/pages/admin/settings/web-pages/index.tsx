...
export default function WebPagesPage() {
  ...
  const publishMutation = useMutation({
    ...
    onError: () => {
      toast({
        title: "Errore",
        description:
          "Si è verificato un errore durante l'aggiornamento dello stato della pagina",
        variant: "destructive",
      });
    },
  });
  ...
  if (isLoading)
    return (
      <div className="flex justify-center p-8">Caricamento in corso...</div>
    );
  if (error)
    return (
      <div className="text-red-500 p-8">
        Si è verificato un errore nel caricamento delle pagine
      </div>
    );
      ...
      >
        <TabsList>
          ...
          <TabsTrigger value="mobile">
            ...
            >
              <rect width="7" height="14" x="8.5" y="5" rx="1" />
              <path d="M12 17v.01" />
            </svg>
            Pagine Mobile
          </TabsTrigger>
                      ...
                      <TableRow key={page.id}>
                        ...
                        <TableCell className="text-right">
                          <div className="flex justify-end gap-2">
                            ...
                            <Button variant="ghost" size="icon" asChild>
                              <Link
                                href={`/admin/settings/web-pages/edit/${page.id}`}
                              >
