...
const getPermissionCategories = (t: any) => [
  {
    ...
    items: [
      { id: "view_all", label: t("admin.roles.permissions.viewAllActivities") },
      {
        ...
        label: t("admin.roles.permissions.viewAssignedOnly"),
      },
      {
        id: "view_dashboard",
        label: t("admin.roles.permissions.viewDashboard"),
      },
      { id: "view_settings", label: t("admin.roles.permissions.viewSettings") },
      {
        id: "view_registration",
        label: t("admin.roles.permissions.viewRegistration"),
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        id: "client.create",
        label: t("admin.roles.permissions.createClients"),
      },
      { id: "client.edit", label: t("admin.roles.permissions.editClients") },
      {
        id: "client.delete",
        label: t("admin.roles.permissions.deleteClients"),
      },
      {
        id: "client.view_all",
        label: t("admin.roles.permissions.viewAllClients"),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        id: "activity.view",
        label: t("admin.roles.permissions.viewActivities"),
      },
      {
        id: "activity.create",
        label: t("admin.roles.permissions.createActivities"),
      },
      {
        id: "activity.edit",
        label: t("admin.roles.permissions.editActivities"),
      },
      {
        id: "activity.delete",
        label: t("admin.roles.permissions.deleteActivities"),
      },
      {
        id: "activity.complete",
        label: t("admin.roles.permissions.completeActivities"),
      },
      {
        id: "activity.assign",
        label: t("admin.roles.permissions.assignActivities"),
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        label: t("admin.roles.permissions.viewCollaborators"),
      },
      {
        id: "collaborator.create",
        label: t("admin.roles.permissions.createCollaborators"),
      },
      {
        id: "collaborator.edit",
        label: t("admin.roles.permissions.editCollaborators"),
      },
      {
        id: "collaborator.delete",
        label: t("admin.roles.permissions.deleteCollaborators"),
      },
      {
        id: "collaborator.assign",
        label: t("admin.roles.permissions.assignToCollaborators"),
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        id: "invoice.create",
        label: t("admin.roles.permissions.createInvoices"),
      },
      { id: "invoice.edit", label: t("admin.roles.permissions.editInvoices") },
      {
        id: "invoice.delete",
        label: t("admin.roles.permissions.deleteInvoices"),
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "report.export",
        label: t("admin.roles.permissions.exportReports"),
      },
      {
        id: "report.custom",
        label: t("admin.roles.permissions.createReports"),
      },
    ],
  },
  {
...
const getAvailablePermissions = (t: any) =>
  getPermissionCategories(t).flatMap((category) => category.items);
...
export default function AdminRolesPage() {
  ...
  const form = useForm<RoleFormValues>({
    resolver: zodResolver(roleSchema) as unknown as Resolver<RoleFormValues>,
    defaultValues: {
      name: "",
      description: "",
      sectorId: null,
  ...
  const createMutation = useMutation({
    mutationFn: (data: RoleFormValues) => {
      ...
      const formattedData = {
        ...data,
        sectorId:
          data.sectorId && data.sectorId !== "none"
        ...
        <div className="flex flex-wrap gap-1">
          ...
          {permissionArray.length > 3 && (
            <Badge variant="outline" className="text-xs">
              +{permissionArray.length - 3}{" "}
              {t("admin.roles.table.permissionsCount")}
            </Badge>
          )}
        </div>
      );
          ...
          {isLoadingRoles ? (
            ...
            <div className="flex flex-col items-center justify-center py-10">
              <p className="text-gray-500 mb-4">
                {t("admin.roles.noRolesAvailable")}
              </p>
              <Button
                ...
                {Array.isArray(roles) &&
                  roles.map((role: any) => (
                    <TableRow key={role.id}>
                      ...
                      <TableCell>
                        {role.description ||
                          t("admin.roles.table.noDescription")}
                      </TableCell>
                      ...
                      <TableCell>
                        ...
                        >
                          {role.isDefault
                            ? t("admin.roles.table.yes")
                            : t("admin.roles.table.no")}
                        </span>
                      </TableCell>
                    ...
                    >
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue
                            placeholder={t(
                              "admin.roles.form.sectorPlaceholder"
                            )}
                          />
                        </SelectTrigger>
                      </FormControl>
                    ...
                    <div className="space-y-6">
                      {getPermissionCategories(t).map((category) => (
                        ...
                        >
                          ...
                          {category.name ===
                            t("admin.roles.permissions.general") && (
                                ...
                                <FormField
                                  ...
                                  render={({ field }) => {
                                    ...
                                    const viewAllSelected =
                                      field.value?.includes("view_all");
                                    const viewAssignedSelected =
                                    ...
                                    return (
                                      <div className="border rounded-lg p-3 space-y-3">
                                        <h4 className="font-medium">
                                          {t(
                                            "admin.roles.form.activityVisibility"
                                          )}
                                        </h4>
                                        <div className="flex flex-col space-y-2">
                                          <div className="flex items-center space-x-2">
                                            ...
                                            >
                                              {t(
                                                "admin.roles.form.seeAllActivities"
                                              )}
                                            </label>
                                          </div>
                                          <div className="flex items-center space-x-2">
                                            ...
                                            />
                                            <label
                                              htmlFor="view_assigned_only"
                                              className="text-sm font-medium"
                                            >
                                              {t(
                                                "admin.roles.form.seeOnlyAssignedActivities"
                                              )}
                                            </label>
                                          </div>
                                        </div>
                              ...
                              <div className="border rounded-lg p-4">
                                <div className="flex justify-between items-center mb-4">
                                  ...
                                  <p className="text-xs text-gray-500">
                                    Seleziona i permessi per questa categoria
                                  </p>
                                </div>
                                  ...
                                  <table className="w-full border-collapse">
                                    <thead>
                                      <tr className="bg-gray-50">
                                        ...
                                        <th className="border p-2 text-center font-medium text-sm">
                                          Visualizza
                                        </th>
                                        <th className="border p-2 text-center font-medium text-sm">
                                          Crea
                                          ...
                                          <FormField
                                            ...
                                            render={({ field }) => (
                                              <FormItem className="m-0 flex justify-center">
                                                ...
                                                <FormLabel className="ml-2 my-0 text-xs">
                                  ...
                                  <table className="w-full border-collapse">
                                    ...
                                    <tbody>
                                                ...
                                                <FormControl>
                                                  <Checkbox
                                                    ...
                                                    onCheckedChange={(
                                                      ...
                                                      const permissionId = `${category.name
                                                        .toLowerCase()
                                                        .replace("à", "a")
                                                        .replace(
                                                          "è",
                                      ...
                                      {category.name === "Lavori" && (
                                        <tr>
                                          <td className="border p-2 text-sm">
                                            Tutti i {category.name}
                                          </td>
                                          <td
                                            className="border p-2 text-center"
                                            colSpan={
                                              category.name === "Lavori" ? 5 : 4
                                            }
                                          >
                                            <FormField
                                              control={form.control}
                                            ...
                                            <FormField
                                              ...
                                              render={({ field }) => (
                                                <FormItem className="m-0 flex justify-center">
                                                  ...
                                                  <FormLabel className="ml-2 my-0 text-xs">
                                                    Può registrare orari e
                                                    materiali dei lavori
                                                  </FormLabel>
                                                </FormItem>
                                              )}
                                            />
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                    <div className="space-y-0.5">
                      ...
                      <div className="text-sm text-gray-500">
                        Se attivato, questo ruolo verrà proposto di default per
                        il settore selezionato
                      </div>
                    </div>
                    <FormControl>
                      <Switch
