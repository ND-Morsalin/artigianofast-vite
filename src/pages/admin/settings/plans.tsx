    ...
    <div className="container mx-auto py-8">
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="border-l-4 border-green-500 pl-4 py-2">
              ...
              <p className="text-sm text-gray-600">{t("define_page_access")}</p>
            </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t("configure_subscription_plans")}</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
                                    ...
                                    return (
                                      <div>
                                        <div className="flex items-center gap-1 text-green-600 font-medium">
                                          ...
                                          {totalFeatures} {t("features_active")}
                                        </div>
                                      ...
                                      setTimeout(() => {
                                        const featureTab =
                                          document.querySelector(
                                            '[data-state="inactive"][value="features"]'
                                          );
                                        if (featureTab) {
                ...
                <Tabs defaultValue="features">
                  ...
                  <TabsContent value="features">
                    <FormField
                      ...
                      name="features"
                      render={({ field }) => {
                        const featuresObject = field.value
                        ...
                        const featureCategories = [
                          {
                            title: t(
                              "admin.settings.planFeatures.entity_management"
                            ),
                          ...
                          {
                            title: t(
                              "admin.settings.planFeatures.operational_tools"
                            ),
                            features: availableFeatures.filter((f) =>
                              [
                                "activity_tracking",
                          ...
                          {
                            title: t(
                              "admin.settings.planFeatures.documentation_analysis"
                            ),
                            features: availableFeatures.filter((f) =>
                              [
                                "invoice_generation",
                          ...
                          <FormItem>
                            <div className="mb-4 bg-blue-50 p-4 rounded-lg border border-blue-200">
                              <h3 className="font-medium text-blue-700 mb-2 flex items-center gap-2">
                                ...
                                {t(
                                  "admin.settings.planFeatures.feature_configuration"
                                )}
                              </h3>
                              <p className="text-sm text-blue-600">
                                {t(
                                  "admin.settings.planFeatures.select_features_to_include_in_plan"
                                )}
                                {t(
                                  "admin.settings.planFeatures.for_some_features_you_can_set_limits"
                                )}
                              </p>
                            </div>
                                ...
                                >
                                  ...
                                  <div className="divide-y">
                                    {category.features.map((feature) => {
                                      const enabled =
                                        featuresObject[feature.id] !==
                                        undefined;
                                      const hasLimit =
                                        typeof featuresObject[feature.id] ===
                                        "number";
                                            ...
                                            >
                                              <div className="flex items-center gap-2">
                                                <h4 className="font-medium">
                                                  {t(
                                                    `admin.settings.planFeatures.features.${feature.id}.name`
                                                  )}
                                                </h4>
                                                {enabled && (
                                              ...
                                              <p className="text-sm text-gray-500 mt-1">
                                                {t(
                                                  `admin.settings.planFeatures.features.${feature.id}.description`
                                                )}
                                              </p>
                                            </div>
                                            <Switch
                                              ...
                                              <div className="mt-4 flex items-center gap-2 bg-gray-50 p-3 rounded-lg">
                                                <div className="flex-1">
                                                  <p className="text-sm font-medium">
                                                    {t(
                                                      "admin.settings.planFeatures.max_limit"
                                                    )}
                                                  </p>
                                                  <p className="text-xs text-gray-500">
                                                    {t(
                                                      "admin.settings.planFeatures.set_max_limit_for"
                                                    )}
                                                  </p>
                                                </div>
                                                <div className="flex items-center gap-2">
                                                  <Input
                                                    ...
                                                    className="w-24"
                                                    placeholder={t(
                                                      "admin.settings.planFeatures.unlimited_placeholder"
                                                    )}
                                                  />
                                                  <div className="text-xs text-gray-500 whitespace-nowrap">
                                                    (
                                                    {t(
                                                      "admin.settings.planFeatures.zero_unlimited"
                                                    )}
                                                    )
                                                  </div>
                                                </div>
                      ...
                      render={({ field }) => {
                        ...
                        const updateFieldVisibility = (
                          ...
                          if (!newFeatures.visible_fields[entity]) {
                            ...
                            const entityFieldList = (entityFields as any)[
                              entity
                            ];
                            if (entityFieldList) {
                              newFeatures.visible_fields[entity] =
                                entityFieldList.map((f: any) => f.id);
                            } else {
                              newFeatures.visible_fields[entity] = [];
                            }
                          }
                          ...
                          if (isVisible) {
                            if (
                              !newFeatures.visible_fields[entity].includes(
                                fieldId
                              )
                            ) {
                            ...
                            newFeatures.visible_fields[entity] =
                              newFeatures.visible_fields[entity].filter(
                        ...
                        return (
                          <FormItem>
                            <div className="space-y-6">
                              {Object.entries(entityFields).map(
                                ([entity, fields]) => (
                                  <div
                                    key={entity}
                        ...
                        const permissionGroups = [
                          {
                            ...
                            permissions: [
                              {
                                id: "client.create",
                                label: t("create_new_clients"),
                              },
                              {
                                id: "client.edit",
                                label: t("edit_existing_clients"),
                              },
                              {
                                id: "client.delete",
                                label: t("delete_clients"),
                              },
                              {
                                id: "client.view_all",
                                label: t("view_all_clients"),
                              },
                            ],
                          },
                          {
                          ...
                          },
                          {
                            ...
                            permissions: [
                              {
                                id: "invoice.create",
                                label: t("create_invoices"),
                              },
                              { id: "invoice.edit", label: t("edit_invoices") },
                              {
                                id: "invoice.delete",
                                label: t("delete_invoices"),
                              },
                          ...
                          },
                          {
                            ...
                            permissions: [
                              ...
                              },
                              {
                                ...
                                label: t("remove_collaborators"),
                              },
                              {
                                id: "collaborator.assign",
                                label: t("assign_activities_to_collaborators"),
                              },
                            ],
                          },
                          {
                          ...
                          <FormItem>
                            ...
                            <div className="space-y-6">
                              {permissionGroups.map((group) => {
                                ...
                                const enabledPermissionsInGroup =
                                  allPermissionsInGroup.filter(
                                    (id) => permissions[id] === true
                                  );
                                const allEnabled =
                                  allPermissionsInGroup.length ===
                                    ...
                                    <div className="bg-gray-50 p-3 flex justify-between items-center border-b">
                                      ...
                                      <div className="flex items-center gap-3">
                                        ...
                                        <Switch
                                          ...
                                          className={
                                            someEnabled
                                              ? "data-[state=checked]:bg-amber-500 data-[state=checked]:text-amber-50 border border-gray-300"
                                              : "border border-gray-300 data-[state=checked]:border-primary"
                                          }
                                          onCheckedChange={(checked) =>
                                            toggleAllInGroup(
                                              group.name,
