...
const generalSettingsSchema = z.object({
  ...
  defaultNotificationTime: z.coerce
    .number()
    .min(0, "Il tempo di notifica non può essere negativo"),
  ...
  sessionTimeout: z.coerce
    .number()
    .min(5, "Il timeout deve essere almeno 5 minuti"),
  passwordMinLength: z.coerce
    .number()
    .min(6, "La lunghezza minima deve essere almeno 6 caratteri"),
  ...
  defaultPageSize: z.coerce
    .number()
    .min(5, "La dimensione pagina deve essere almeno 5"),
  maxUploadFileSize: z.coerce
    .number()
    .min(1, "La dimensione massima deve essere almeno 1MB"),
          ...
          <Tabs defaultValue="app" className="w-full">
            <TabsList className="mb-4">
              <TabsTrigger value="app">
                {t("admin.general.tabs.app")}
              </TabsTrigger>
              <TabsTrigger value="notifications">
                {t("admin.general.tabs.notifications")}
              </TabsTrigger>
              <TabsTrigger value="datetime">
                {t("admin.general.tabs.datetime")}
              </TabsTrigger>
              <TabsTrigger value="security">
                {t("admin.general.tabs.security")}
              </TabsTrigger>
              <TabsTrigger value="other">
                {t("admin.general.tabs.other")}
              </TabsTrigger>
            </TabsList>
                ...
                <CardContent className="space-y-4">
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder={t(
                              "admin.general.form.appNamePlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                        <FormDescription>
                          Il nome visualizzato nell'interfaccia e nei titoli
                          delle pagine
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("admin.general.form.defaultLanguage")}
                        </FormLabel>
                        <Select
                        ...
                        >
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue
                                placeholder={t(
                                  "admin.general.form.defaultLanguagePlaceholder"
                                )}
                              />
                            </SelectTrigger>
                          </FormControl>
                ...
                <CardContent className="space-y-4">
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                        <div className="space-y-0.5">
                          <FormLabel>
                            {t("admin.general.form.enableEmailNotifications")}
                          </FormLabel>
                          <FormDescription>
                            {t(
                              "admin.general.form.enableEmailNotificationsDescription"
                            )}
                          </FormDescription>
                        </div>
                        <FormControl>
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                        <div className="space-y-0.5">
                          <FormLabel>
                            {t(
                              "admin.general.form.enableWhatsAppNotifications"
                            )}
                          </FormLabel>
                          <FormDescription>
                            {t(
                              "admin.general.form.enableWhatsAppNotificationsDescription"
                            )}
                          </FormDescription>
                        </div>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("admin.general.form.defaultNotificationTime")}
                        </FormLabel>
                        <FormControl>
                          <Input
                            type="number"
                            placeholder={t(
                              "admin.general.form.defaultNotificationTimePlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                        <FormDescription>
                          Quanto tempo prima inviare le notifiche di
                          appuntamenti
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                ...
                <CardContent className="space-y-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("admin.general.form.dateFormat")}
                        </FormLabel>
                        <Select
                          onValueChange={field.onChange}
                          defaultValue={field.value}
                        >
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue
                                placeholder={t(
                                  "admin.general.form.dateFormatPlaceholder"
                                )}
                              />
                            </SelectTrigger>
                          </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("admin.general.form.timeFormat")}
                        </FormLabel>
                        <Select
                          onValueChange={field.onChange}
                          defaultValue={field.value}
                        >
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue
                                placeholder={t(
                                  "admin.general.form.timeFormatPlaceholder"
                                )}
                              />
                            </SelectTrigger>
                          </FormControl>
                        ...
                        >
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue
                                placeholder={t(
                                  "admin.general.form.timezonePlaceholder"
                                )}
                              />
                            </SelectTrigger>
                          </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("admin.general.form.weekStartsOn")}
                        </FormLabel>
                        <Select
                          onValueChange={field.onChange}
                          defaultValue={field.value}
                ...
                <CardContent className="space-y-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("admin.general.form.sessionTimeout")}
                        </FormLabel>
                        <FormControl>
                          <Input
                            type="number"
                            placeholder={t(
                              "admin.general.form.sessionTimeoutPlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                        <FormDescription>
                          Dopo quanto tempo di inattività la sessione viene
                          chiusa
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("admin.general.form.passwordMinLength")}
                        </FormLabel>
                        <FormControl>
                          <Input
                            type="number"
                            placeholder={t(
                              "admin.general.form.passwordMinLengthPlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                        <FormDescription>
                          Il numero minimo di caratteri richiesti per le
                          password
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                        <div className="space-y-0.5">
                          <FormLabel>
                            {t("admin.general.form.passwordRequireNumbers")}
                          </FormLabel>
                          <FormDescription>
                            {t(
                              "admin.general.form.passwordRequireNumbersDescription"
                            )}
                          </FormDescription>
                        </div>
                        <FormControl>
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                        <div className="space-y-0.5">
                          <FormLabel>
                            {t(
                              "admin.general.form.passwordRequireSpecialChars"
                            )}
                          </FormLabel>
                          <FormDescription>
                            {t(
                              "admin.general.form.passwordRequireSpecialCharsDescription"
                            )}
                          </FormDescription>
                        </div>
                        <FormControl>
                ...
                <CardContent className="space-y-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("admin.general.form.defaultPageSize")}
                        </FormLabel>
                        <FormControl>
                          <Input
                            type="number"
                            placeholder={t(
                              "admin.general.form.defaultPageSizePlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                        <FormDescription>
                          Numero di elementi visualizzati in ogni pagina delle
                          tabelle
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("admin.general.form.maxUploadFileSize")}
                        </FormLabel>
                        <FormControl>
                          <Input
                            type="number"
                            placeholder={t(
                              "admin.general.form.maxUploadFileSizePlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                        <FormDescription>
                          La dimensione massima dei file che possono essere
                          caricati
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("admin.general.form.allowedFileTypes")}
                        </FormLabel>
                        <FormControl>
                          <Input
                            placeholder={t(
                              "admin.general.form.allowedFileTypesPlaceholder"
                            )}
                            {...field}
                          />
                        </FormControl>
                        <FormDescription>
                          Estensioni dei file permessi, separati da virgole (es.
                          jpg,png,pdf)
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
