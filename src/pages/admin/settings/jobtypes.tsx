...
console.log(isLoadingSectors)
  ...
  const form = useForm<JobTypeFormValues>({
    resolver: zodResolver(
      jobTypeSchema
    ) as unknown as Resolver<JobTypeFormValues>,
    defaultValues: {
      name: "",
      description: "",
      sectorIds: [],
  ...
  //         return sector
  //           ? sector.name
  //           : `${t("admin.jobTypes.table.sectors")} #${id}`;
  //       })
  //       .join(", ");
  //   } catch (e) {
  ...
  const getSectorBadges = (sectorIds: string) => {
    console.log("🔍 getSectorBadges called with:", {
      sectorIds,
    ...
    <div className="container mx-auto py-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t("jobTypes.description")}</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoadingJobTypes ? (
            ...
            <div className="flex flex-col items-center justify-center py-10">
              <p className="text-gray-500 mb-4">
                {t("jobTypes.noJobTypesAvailable")}
              </p>
              <Button
                ...
                {Array.isArray(jobTypes) &&
                  jobTypes.map((jobType: any) => (
                    <TableRow key={jobType.id}>
                      ...
                      <TableCell>
                        {jobType.description ||
                          t("jobTypes.table.noDescription")}
                      </TableCell>
                      <TableCell>
                        {getSectorBadges(jobType.sectorIds) ||
                          t("admin.jobTypes.table.noSectors")}
                      </TableCell>
                      <TableCell>
                        <span
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder={t("jobTypes.form.namePlaceholder")}
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
