...
export default function StatisticsPage() {
  ...
  console.log("Fetched stats:", isLoading);
          ...
          <Select value={activePeriod} onValueChange={setActivePeriod}>
            ...
            <SelectContent>
              <SelectItem value="week">
                {t("admin.statistics.periods.week")}
              </SelectItem>
              <SelectItem value="month">
                {t("admin.statistics.periods.month")}
              </SelectItem>
              <SelectItem value="quarter">
                {t("admin.statistics.periods.quarter")}
              </SelectItem>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
            <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
              <h3 className="text-sm text-slate-500 mb-1">
                {t("admin.statistics.metrics.totalSubscriptions")}
              </h3>
              <p className="text-2xl font-bold">
                {stats?.subscriptionsStats?.total || 0}
              </p>
              <p className="text-xs text-green-600 mt-2">
                {stats?.subscriptionsStats?.active || 0} attivi
              </p>
            </div>

            <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
              <h3 className="text-sm text-slate-500 mb-1">
                {t("admin.statistics.metrics.totalClients")}
              </h3>
              <p className="text-2xl font-bold">
                {stats?.clientsStats?.total || 0}
              </p>
              <p className="text-xs text-green-600 mt-2">
                +{stats?.clientsStats?.new || 0} nell'ultimo periodo
              </p>
            </div>

            <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
              <h3 className="text-sm text-slate-500 mb-1">
                {t("admin.statistics.metrics.totalRevenue")}
              </h3>
              <p className="text-2xl font-bold">
                {formatCurrency(stats?.revenueStats?.total || 0)}
              </p>
              <p className="text-xs text-green-600 mt-2">
                {formatCurrency(stats?.revenueStats?.monthly || 0)} mensile
              </p>
            </div>

            <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
              <h3 className="text-sm text-slate-500 mb-1">
                {t("admin.statistics.metrics.avgSessionDuration")}
              </h3>
              <p className="text-2xl font-bold">
                {stats?.usageStats?.avgSessionDuration || 0} min
              </p>
              <p className="text-xs text-slate-600 mt-2">
                {stats?.usageStats?.avgSessionsPerUser || 0} sessioni per utente
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium">
                {t("admin.statistics.filters.sector")}:
              </span>
              <Select value={selectedSector} onValueChange={setSelectedSector}>
                <SelectTrigger className="w-[180px]">
                  <SelectValue
                    placeholder={t("admin.statistics.filters.allSectors")}
                  />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="all">
                    {t("admin.statistics.filters.allSectors")}
                  </SelectItem>
            ...
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium">
                {t("admin.statistics.filters.plan")}:
              </span>
              <Select value={selectedPlan} onValueChange={setSelectedPlan}>
                <SelectTrigger className="w-[180px]">
                  <SelectValue
                    placeholder={t("admin.statistics.filters.allPlans")}
                  />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="all">
                    {t("admin.statistics.filters.allPlans")}
                  </SelectItem>
                  {plans.map((plan: any) => (
            ...
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium">
                {t("admin.statistics.filters.clientType")}:
              </span>
              <Select
      ...
      <Tabs defaultValue="subscriptions" className="w-full">
        <TabsList className="w-full mb-6">
          <TabsTrigger value="subscriptions">
            {t("admin.statistics.tabs.subscriptions")}
          </TabsTrigger>
          <TabsTrigger value="clients">
            {t("admin.statistics.tabs.clients")}
          </TabsTrigger>
          <TabsTrigger value="revenue">
            {t("admin.statistics.tabs.revenue")}
          </TabsTrigger>
          <TabsTrigger value="usage">
            {t("admin.statistics.tabs.usage")}
          </TabsTrigger>
        </TabsList>
            ...
            >
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  ...
                  <Tooltip
                    formatter={(value: number  | undefined) => [value, "Abbonamenti"]}
                  />
                  <Legend />
                </PieChart>
              </ResponsiveContainer>
