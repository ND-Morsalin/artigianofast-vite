    ...
    <div className="container mx-auto py-8">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-3xl font-bold">
          {t("admin.settings.adminEdit.title")}
        </h1>
      </div>
                  ...
                  >
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>
                            {t("admin.settings.adminEdit.username")}
                          </FormLabel>
                          <FormControl>
                            <Input
                              placeholder={t(
                                "admin.settings.adminEdit.usernamePlaceholder"
                              )}
                              {...field}
                            />
                          </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>
                            {t("admin.settings.adminEdit.fullName")}
                          </FormLabel>
                          <FormControl>
                            <Input
                              placeholder={t(
                                "admin.settings.adminEdit.fullNamePlaceholder"
                              )}
                              {...field}
                            />
                          </FormControl>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>
                              {t("admin.settings.adminEdit.email")}
                            </FormLabel>
                            <FormControl>
                              <Input
                                type="email"
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>
                              {t("admin.settings.adminEdit.phone")}
                            </FormLabel>
                            <FormControl>
                              <Input
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>
                            {t("admin.settings.adminEdit.role")}
                          </FormLabel>
                          <Select
                          ...
                          >
                            <FormControl>
                              <SelectTrigger>
                                <SelectValue
                                  placeholder={t(
                                    "admin.settings.adminEdit.selectRole"
                                  )}
                                />
                              </SelectTrigger>
                            </FormControl>
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                          <div className="space-y-0.5">
                            <FormLabel>
                              {t("admin.settings.adminEdit.userStatus")}
                            </FormLabel>
                            <FormDescription>
                              {t(
                                "admin.settings.adminEdit.userStatusDescription"
                              )}
                            </FormDescription>
                          </div>
                          <FormControl>
                    ...
                    <div className="flex justify-end gap-4">
                      <Button
                        ...
                        onClick={() =>
                          setLocation(
                            `/admin/administrators/${adminId}/password`
                          )
                        }
                      >
                  ...
                  {admin && (
                    <>
                      ...
                      <div>
                        ...
                        <p>
                          {roles.find((r: { id: any }) => r.id === admin.roleId)
                            ?.name || "Nessun ruolo assegnato"}
                        </p>
                      </div>
                    </>
                  )}
