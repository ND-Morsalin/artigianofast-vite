...
export default function ReportsPage() {
  ...
  const enabledFeatures = currentPlan
    ? Object.keys(planFeatures).filter((key) => planFeatures[key] === true)
    : [];
  ...
  console.log({ invoicesLoading, clientsLoading, jobsLoading });
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="outline">
                    {invoicesError ? 0 : invoices.length}
                  </Badge>
                </div>
              </div>
            </CardContent>
