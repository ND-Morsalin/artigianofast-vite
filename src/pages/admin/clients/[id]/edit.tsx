...
const clientSchema = z.object({
  ...
  type: z
    .string()
    .refine(
      (val) => ["residential", "commercial", "industrial"].includes(val),
      {
    ...
    <div className="container mx-auto py-8">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-3xl font-bold">
          {t("admin.settings.clientEdit.title")}
        </h1>
      </div>
              ...
              >
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("admin.settings.clientEdit.name")}
                      </FormLabel>
                      <FormControl>
                        <Input
                          placeholder={t(
                            "admin.settings.clientEdit.namePlaceholder"
                          )}
                          {...field}
                        />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("admin.settings.clientEdit.type")}
                      </FormLabel>
                      <Select
                        value={field.value}
                      ...
                      >
                        <FormControl>
                          <SelectTrigger>
                            <SelectValue
                              placeholder={t(
                                "admin.settings.clientEdit.typePlaceholder"
                              )}
                            />
                          </SelectTrigger>
                        </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("admin.settings.clientEdit.address")}
                      </FormLabel>
                      <FormControl>
                        <Input
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("admin.settings.clientEdit.geoLocation")}
                      </FormLabel>
                      <FormControl>
                        <Input
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("admin.settings.clientEdit.notes")}
                      </FormLabel>
                      <FormControl>
                        <Textarea
                          placeholder={t(
                            "admin.settings.clientEdit.notesPlaceholder"
                          )}
