...
export default function ClientDetailsPage() {
  ...
  const form = useForm<PlanCustomizationFormValues>({
    resolver: zodResolver(
      planCustomizationSchema
    ) as unknown as Resolver<PlanCustomizationFormValues>,
    defaultValues: {
      planId: clientSubscription?.planId || 0,
      customFeatures: clientSubscription?.customFeatures || null,
      customPricing:
        !!clientSubscription?.customMonthlyPrice ||
        !!clientSubscription?.customYearlyPrice,
  ...
  const updatePlanMutation = useMutation({
    ...
    onError: (error) => {
      ...
      toast({
        ...
        description: `${t(
          "admin.settings.clientDetails.errorUpdatingPlan"
        )}: ${error}`,
        variant: "destructive",
      });
    },
  ...
  const getExpiryDate = () => {
    if (!clientSubscription?.endDate)
      return t("admin.settings.clientDetails.noExpiration");
    ...
    <div className="container mx-auto py-8">
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-3xl font-bold">
            {t("admin.settings.clientDetails.title")}
          </h1>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            <CardTitle className="flex justify-between items-center">
              ...
              >
                {client.type === "residential"
                  ? t("admin.settings.clientEdit.residential")
                  : client.type === "commercial"
                  ? t("admin.settings.clientEdit.commercial")
                  : t("admin.settings.clientEdit.industrial")}
              </Badge>
            </CardTitle>
            <CardDescription>
              {client.address ||
                t("admin.settings.clientDetails.noAddressSpecified")}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-sm font-medium text-gray-500 mb-2">
                  {t("admin.settings.clientDetails.contactInformation")}
                </h3>
                <div className="space-y-2">
                  <div className="flex items-start">
                    <span className="text-gray-500 w-24">
                      {t("admin.settings.clientEdit.email")}:
                    </span>
                    <span>{client.email || "-"}</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-gray-500 w-24">
                      {t("admin.settings.clientEdit.phone")}:
                    </span>
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-500 mb-2">
                  {t("admin.settings.clientDetails.taxInformation")}
                </h3>
                <div className="space-y-2">
                  <div className="flex items-start">
            ...
            <div>
              <h3 className="text-sm font-medium text-gray-500 mb-2">
                {t("admin.settings.clientDetails.notes")}
              </h3>
              <p className="text-gray-700">
                {client.notes ||
                  t("admin.settings.clientDetails.noNotesAvailable")}
              </p>
            </div>
          </CardContent>
          <CardFooter className="justify-end pt-0">
            <Button
              variant="outline"
              onClick={() => setLocation(`/admin/clients/${clientId}/edit`)}
              className="flex items-center gap-2"
            >
              <Edit size={16} />
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              {t("admin.settings.clientDetails.serviceStatus")}
            </CardTitle>
            <CardDescription>
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-500">
                  {t("admin.settings.clientDetails.currentPlan")}
                </h3>
                {isSubscriptionLoading ? (
                  ...
                  <div className="bg-gray-50 p-3 rounded-md">
                    <div className="flex justify-between items-center mb-2">
                      <span className="font-semibold">
                        {currentPlan?.name ||
                          t("admin.settings.clientDetails.customPlan")}
                      </span>
                      <Badge
                        variant={
                      ...
                      >
                        {clientSubscription.status === "active"
                          ...
                          : t("admin.settings.clientDetails.inactive")}
                      </Badge>
                    </div>
                    <div className="space-y-1 text-sm">
                      <div className="flex justify-between">
                        <span className="text-gray-500">
                          {t("admin.settings.clientDetails.billing")}:
                        </span>
                        <span>
                          {clientSubscription.billingFrequency === "monthly"
                            ? t("admin.settings.clientPlan.perMonth")
                            : t("admin.settings.clientDetails.annual")}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-500">
                          {t("admin.settings.clientDetails.price")}:
                        </span>
                        <span>
                          €
                          {clientSubscription.customMonthlyPrice ||
                            ...
                            0}{" "}
                          / {t("admin.settings.clientDetails.perMonth")}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-500">
                          {t("admin.settings.clientDetails.expiration")}:
                        </span>
                  ...
                  <div className="bg-gray-50 p-3 rounded-md">
                    <p className="text-gray-500">
                      {t("admin.settings.clientDetails.noExpiration")}
                    </p>
                  </div>
                )}
              </div>
              ...
              >
                {clientSubscription
                  ? t("admin.settings.clientDetails.customizePlan")
                  : t("admin.settings.clientDetails.customizePlan")}
              </Button>

              <div className="pt-4 border-t border-gray-200">
                <h3 className="text-sm font-medium text-gray-500 mb-3">
                  {t("admin.settings.clientDetails.usageStatistics")}
                </h3>
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-500">
                      {t("admin.settings.clientDetails.totalJobs")}:
                    </span>
                    <span className="font-medium">0</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-500">
                      {t("admin.settings.clientDetails.spaceUsed")}:
                    </span>
                    <span className="font-medium">0 MB</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-500">
                      {t("admin.settings.clientDetails.accesses")}:
                    </span>
                    <span className="font-medium">0</span>
                  </div>
                </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {t("admin.settings.clientDetails.clientManagement")}
          </CardTitle>
          <CardDescription>
        ...
        <CardContent>
          <Tabs defaultValue="jobs">
            ...
            <TabsContent value="jobs" className="pt-4">
              <div className="p-20 flex flex-col items-center justify-center">
                <p className="text-gray-500 mb-2">
                  {t("admin.settings.clientDetails.noJobsFound")}
                </p>
            ...
            <TabsContent value="invoices" className="pt-4">
              <div className="p-20 flex flex-col items-center justify-center">
                <p className="text-gray-500 mb-2">
                  {t("admin.settings.clientDetails.noInvoicesFound")}
                </p>
            ...
            <TabsContent value="calendar" className="pt-4">
              <div className="p-20 flex flex-col items-center justify-center">
                <p className="text-gray-500">
                  {t("admin.settings.clientDetails.noCalendarEvents")}
                </p>
              </div>
            </TabsContent>
            ...
            <TabsContent value="collaborators" className="pt-4">
              <div className="p-20 flex flex-col items-center justify-center">
                <p className="text-gray-500 mb-2">
                  {t("admin.settings.clientDetails.noCollaboratorsAssigned")}
                </p>
            ...
            <TabsContent value="inventory" className="pt-4">
              <div className="p-20 flex flex-col items-center justify-center">
                <p className="text-gray-500 mb-2">
                  {t("admin.settings.clientDetails.noInventoryItems")}
                </p>
      ...
      <Dialog open={isPlanDialogOpen} onOpenChange={setIsPlanDialogOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <Form {...form}>
            <form
              onSubmit={form.handleSubmit(onSubmitPlanCustomization)}
              className="space-y-4"
            >
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {t("admin.settings.clientDetails.basePlan")}
                    </FormLabel>
                    <Select
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>
                        Abilita questa opzione per personalizzare funzionalità e
                        prezzi
                      </FormDescription>
                    </div>
                    <FormControl>
                ...
                <>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Funzionalità personalizzate (JSON)
                        </FormLabel>
                        <FormControl>
                          <Textarea
                        ...
                        <FormDescription>
                          Definisci quali funzionalità sono disponibili per
                          questo cliente in formato JSON
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                        <div className="space-y-0.5">
                          ...
                          <FormDescription>
                            Abilita per impostare un prezzo diverso da quello
                            del piano base
                          </FormDescription>
                        </div>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Lascia vuoto per utilizzare la durata di default o per
                          un piano illimitato
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
