        ...
        if (response.data) {
          ...
          if (session.user && session.user.role !== "superadmin") {
            ...
            toast({
              ...
              description:
                "Questa dashboard è riservata ai Super Amministratori",
              variant: "destructive",
            });
          }
        }
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold">
                  €
                  {Array.isArray(stats.revenueMonthly)
                    ? stats.revenueMonthly
                        .reduce(
                          (sum: number, item: { value: any }) =>
          ...
          >
                ...
                <CardContent>
                  <div className="space-y-4">
                    <h3 className="text-lg font-medium">
                      {t("admin.dashboard.recentInformation")}
                    </h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <Card>
                        <CardHeader className="pb-2">
                          <CardTitle className="text-base">
                            {t("admin.dashboard.expiringSubscriptions")}
                          </CardTitle>
                        </CardHeader>
                        <CardContent>
                          {stats.expiringSoon > 0 ? (
                      ...
                      <Card>
                        <CardHeader className="pb-2">
                          <CardTitle className="text-base">
                            {t("admin.dashboard.lastAccesses")}
                          </CardTitle>
                        </CardHeader>
                        <CardContent>
                          {stats.recentLogins &&
                              ...
                              <div className="space-y-1">
                                {stats.recentLogins
                                  ...
                                  .map((login: any, index: number) => (
                                    ...
                                    >
                                      {login.username} ({login.user_type}) -{" "}
                                      {new Date(
                                        login.login_time
                                      ).toLocaleString()}
                                    </div>
            ...
            <TabsContent value="clients">
              <Card>
                <CardHeader>
                  <CardTitle>
                    {t("admin.dashboard.clientManagement.title")}
                  </CardTitle>
                  <CardDescription>
                ...
                <CardContent>
                  <div className="flex justify-between mb-4">
                    <div className="space-x-2">
                      <Button variant="outline">
                        {t("admin.dashboard.clientManagement.filter")}
                      </Button>
                      <Button variant="outline">
                        {t("admin.dashboard.clientManagement.export")}
                      </Button>
                    </div>
                  ...
                  <div className="border rounded-md">
                    <div className="bg-gray-50 p-3 border-b grid grid-cols-8 font-medium text-sm">
                      ...
                      <div>
                        {t("admin.dashboard.clientManagement.expiration")}
                      </div>
                    ...
                    {clientsLoading || plansLoading || subscriptionsLoading ? (
                      ...
                      <div className="p-8 text-center text-gray-500">
                        {t(
                          "admin.dashboard.clientManagement.noClientsAvailable"
                        )}
                      </div>
                    ) : (
                      <div className="divide-y">
                        {clients.map((client: Client) => {
                          ...
                          const clientSubscription = subscriptions.find(
                            (sub: Subscription) => sub.userId === client.id
                          );

                          // Trova il piano dell'abbonamento (se esiste)
                          const plan = clientSubscription
                            ? plans.find(
                                (p: Plan) => p.id === clientSubscription.planId
                              )
                            : null;
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="text-sm text-gray-600">
                                ...
                                {t(
                                  "admin.dashboard.clientManagement.notAvailable"
                                )}
                              </div>
                              <div className="text-sm text-gray-600">
                                {city}
                              ...
                              <div>
                                {clientSubscription?.endDate ? (
                                  <div className="text-sm">
                                    <div>
                                      {format(
                                        new Date(clientSubscription.endDate),
                                        "dd/MM/yyyy"
                                      )}
                                    </div>
                                    <div
                              ...
                              <div className="flex space-x-1">
                                ...
                                <Button
                                  ...
                                  size="icon"
                                  onClick={() =>
                                    handleNavigation(`clients/${client.id}`)
                                  }
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card
                      ...
                      onClick={() => handleNavigation("settings/sectors")}
                    >
                      <CardHeader className="pb-2">
                        <CardTitle className="text-base">
                          Gestione Settori
                    ...
                    <Card
                      className="cursor-pointer"
                      onClick={() => handleNavigation("settings/job-types")}
                    >
                      <CardHeader className="pb-2">
                        <CardTitle className="text-base">
                          Tipi di Lavoro
                    ...
                    <Card
                      className="cursor-pointer"
                      onClick={() => handleNavigation("settings/activities")}
                    >
                      <CardHeader className="pb-2">
                    ...
                    <Card
                      className="cursor-pointer"
                      onClick={() => handleNavigation("settings/roles")}
                    >
                      <CardHeader className="pb-2">
                        <CardTitle className="text-base">Ruoli</CardTitle>
                        <CardDescription>
                          Gestisci i ruoli degli utenti e le relative
                          autorizzazioni
                        </CardDescription>
                      </CardHeader>
                    </Card>
                    ...
                    <Tabs defaultValue="all">
                      <TabsList>
                        <TabsTrigger value="all">
                          {t("admin.settings.all")}
                        </TabsTrigger>
                        <TabsTrigger value="paid">
                          {t("admin.settings.paid")}
                        </TabsTrigger>
                        <TabsTrigger value="unpaid">
                          {t("admin.settings.unpaid")}
                        </TabsTrigger>
                        <TabsTrigger value="draft">
                          {t("admin.settings.draft")}
                        </TabsTrigger>
                      </TabsList>
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <CardContent>
                          <div className="h-48 bg-gray-100 flex items-center justify-center rounded-md">
                            <p className="text-gray-500">
                              {t("admin.statistics.subscriptionTrend")}
                            </p>
                          </div>
                        </CardContent>
                      </Card>
                      <Card>
                        <CardHeader className="pb-2">
                          <CardTitle className="text-base">
                            {t("admin.statistics.clientsBySector")}
                          </CardTitle>
                        </CardHeader>
                        <CardContent>
                          <div className="h-48 bg-gray-100 flex items-center justify-center rounded-md">
                            <p className="text-gray-500">
                              {t("admin.statistics.sectorDistribution")}
                            </p>
                          </div>
                        </CardContent>
                      </Card>
                    ...
                    <div className="flex justify-end">
                      <Button
                        onClick={() => handleNavigation("statistics/export")}
                      >
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex justify-between mb-4">
                    ...
                    <Button
                      onClick={() => handleNavigation("administrators/create")}
                    >
                      <Plus className="mr-2 h-4 w-4" />
                  ...
                  <Tabs defaultValue="all" className="mb-6">
                    <TabsList>
                      ...
                      <TabsTrigger value="registered">
                        {t("admin.users.payingClients")}
                      </TabsTrigger>
                      <TabsTrigger value="trial">
                        {t("admin.users.trialClients")}
                      </TabsTrigger>
                    </TabsList>
                  </Tabs>
                      ...
                      <div className="divide-y">
                        {administrators.map((user: User) => {
                          ...
                          const userSubscription = subscriptions.find(
                            (sub: Subscription) => sub.userId === user.id
                          );
                          ...
                          //     ? plans.find(
                          //         (p: Plan) => p.id === userSubscription.planId
                          //       )
                          //     : null;
                          ...
                          return (
                            <div
                              key={user.id}
                              className="grid grid-cols-6 gap-2 p-3 items-center hover:bg-gray-50"
                            >
                              <div className="font-medium truncate">
                              ...
                              <div className="flex space-x-1">
                                ...
                                <Button
                                  ...
                                  onClick={() =>
                                    handleNavigation(
                                      `administrators/${user.id}/password`
                                    )
                                  }
