...
const jobSchema = z.object({
  ...
  estimatedDuration: z
    .number()
    .min(0, "Durata stimata non può essere negativa")
    .optional(),
...
export default function JobsPage() {
  ...
  const getStatusInfo = (status: string) => {
    switch (status) {
      case "pending":
        return {
          icon: Clock,
          label: t("jobs.statuses.pending"),
          color: "bg-yellow-100 text-yellow-800",
        };
      case "in_progress":
        return {
          icon: Play,
          label: t("jobs.statuses.in_progress"),
          color: "bg-blue-100 text-blue-800",
        };
      case "completed":
        return {
          icon: CheckCircle,
          label: t("jobs.statuses.completed"),
          color: "bg-green-100 text-green-800",
        };
      case "cancelled":
        return {
          icon: AlertCircle,
          label: t("jobs.statuses.cancelled"),
          color: "bg-red-100 text-red-800",
        };
      case "on_hold":
        return {
          icon: Pause,
          label: t("jobs.statuses.on_hold"),
  ...
  const getPriorityInfo = (priority: string) => {
    switch (priority) {
      case "low":
        return {
          label: t("jobs.priorities.low"),
          color: "bg-gray-100 text-gray-800",
        };
      case "medium":
        return {
          label: t("jobs.priorities.medium"),
          color: "bg-blue-100 text-blue-800",
        };
      case "high":
        return {
          label: t("jobs.priorities.high"),
          color: "bg-orange-100 text-orange-800",
        };
      case "urgent":
        return {
          label: t("jobs.priorities.urgent"),
          color: "bg-red-100 text-red-800",
        };
      default:
                          ...
                          <FormItem>
                            ...
                            >
                              <FormControl>
                                <SelectTrigger>
                                  <SelectValue
                                    placeholder={t("jobs.form.selectClient")}
                                  />
                                </SelectTrigger>
                              </FormControl>
                              <SelectContent>
                          ...
                          <FormItem>
                            ...
                            >
                              <FormControl>
                                <SelectTrigger>
                                  <SelectValue
                                    placeholder={t("jobs.form.selectStatus")}
                                  />
                                </SelectTrigger>
                              </FormControl>
                              <SelectContent>
                                ...
                                <SelectItem value="cancelled">
                                  {t("jobs.statuses.cancelled")}
                                </SelectItem>
                                <SelectItem value="on_hold">
                                  {t("jobs.statuses.on_hold")}
                                </SelectItem>
                              </SelectContent>
                            </Select>
                            <FormMessage />
                          ...
                          <FormItem>
                            ...
                            >
                              <FormControl>
                                <SelectTrigger>
                                  <SelectValue
                                    placeholder={t("jobs.form.selectPriority")}
                                  />
                                </SelectTrigger>
                              </FormControl>
                              <SelectContent>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>
                              {t("jobs.form.estimatedDuration")}
                            </FormLabel>
                            <FormControl>
                              <Input
                                type="number"
                                placeholder={t(
                                  "jobs.form.estimatedDurationPlaceholder"
                                )}
                                {...field}
                                onChange={(e) =>
                                  field.onChange(
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                placeholder={t(
                                  "jobs.form.assignedToPlaceholder"
                                )}
                                {...field}
                              />
                            </FormControl>
                ...
                >
                  ...
                  <CardContent className="pt-0">
                    <div className="space-y-2 text-sm">
                      ...
                      {job.cost && (
                        <div className="text-gray-600">
                          <span className="font-medium">Costo stimato:</span> €
                          {job.cost}
                        </div>
                      )}
                      {job.materials && (
                    ...
                    <div className="mt-4 pt-3 border-t">
                      <div className="text-xs text-gray-500">
                        Aggiornato il{" "}
                        {new Date(job.updatedAt).toLocaleDateString("it-IT")}
                      </div>
                    </div>
                  </CardContent>
                </Card>
