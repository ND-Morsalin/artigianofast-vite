  ...
  const getClientTypeInfo = (type: string) => {
    switch (type) {
      case "residential":
        return {
          icon: Home,
          label: t("clients.types.residential"),
          color: "bg-blue-100 text-blue-800",
        };
      case "commercial":
        return {
          icon: Building,
          label: t("clients.types.commercial"),
          color: "bg-green-100 text-green-800",
        };
      case "industrial":
        return {
          icon: Factory,
          label: t("clients.types.industrial"),
                    ...
                    >
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input
                                  placeholder={t(
                                    "clients.form.postalCodePlaceholder"
                                  )}
                                  {...field}
                                />
                              </FormControl>
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input
                                  placeholder={t(
                                    "clients.form.provincePlaceholder"
                                  )}
                                  {...field}
                                />
                              </FormControl>
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input
                                  placeholder={t(
                                    "clients.form.countryPlaceholder"
                                  )}
                                  {...field}
                                />
                              </FormControl>
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input
                                  placeholder={t(
                                    "clients.form.contactPersonPlaceholder"
                                  )}
                                  {...field}
                                />
                              </FormControl>
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input
                                  placeholder={t(
                                    "clients.form.vatNumberPlaceholder"
                                  )}
                                  {...field}
                                />
                              </FormControl>
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input
                                  placeholder={t(
                                    "clients.form.taxCodePlaceholder"
                                  )}
                                  {...field}
                                />
                              </FormControl>
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                placeholder={t(
                                  "clients.form.websitePlaceholder"
                                )}
                                {...field}
                              />
                            </FormControl>
                      ...
                      <div className="flex justify-end space-x-2 pt-4">
                        ...
                        >
                          ...
                          updateClientMutation.isPending
                            ? editingClient
                              ? t("clients.form.updating")
                              : t("clients.form.creating")
                            : editingClient
                            ? t("clients.form.save")
                            : t("clients.form.save")}
                        </Button>
