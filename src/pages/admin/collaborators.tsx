...
export default function CollaboratorsPage() {
  ...
  const ensureCollaboratorProperties = (collaborator: any): Collaborator => {
    return {
      ...
      mobilePermissions: {
        ...
        canCreateClients:
          collaborator.mobilePermissions?.canCreateClients || false,
        canDeleteClients:
          collaborator.mobilePermissions?.canDeleteClients || false,
        canViewClientDetails:
          collaborator.mobilePermissions?.canViewClientDetails || false,
        canViewClientSensitiveData:
          collaborator.mobilePermissions?.canViewClientSensitiveData || false,
        ...
        canViewJobDetails:
          collaborator.mobilePermissions?.canViewJobDetails || false,
        canViewJobFinancials:
          collaborator.mobilePermissions?.canViewJobFinancials || false,
        canUpdateJobStatus:
          collaborator.mobilePermissions?.canUpdateJobStatus || false,
        canAddJobNotes: collaborator.mobilePermissions?.canAddJobNotes || false,
        canUploadJobPhotos:
          collaborator.mobilePermissions?.canUploadJobPhotos || false,

        // Reports & Analytics
        canViewReports: collaborator.mobilePermissions?.canViewReports || false,
        canCreateReports:
          collaborator.mobilePermissions?.canCreateReports || false,
        canExportReports:
          collaborator.mobilePermissions?.canExportReports || false,
        canViewFinancialReports:
          collaborator.mobilePermissions?.canViewFinancialReports || false,
        canViewPerformanceMetrics:
          collaborator.mobilePermissions?.canViewPerformanceMetrics || false,

        // Invoicing & Financials
        canViewInvoices:
          collaborator.mobilePermissions?.canViewInvoices || false,
        canEditInvoices:
          collaborator.mobilePermissions?.canEditInvoices || false,
        canCreateInvoices:
          collaborator.mobilePermissions?.canCreateInvoices || false,
        canDeleteInvoices:
          collaborator.mobilePermissions?.canDeleteInvoices || false,
        canViewInvoiceAmounts:
          collaborator.mobilePermissions?.canViewInvoiceAmounts || false,
        canViewPaymentHistory:
          collaborator.mobilePermissions?.canViewPaymentHistory || false,

        // Time & Activity Tracking
        canTrackTime: collaborator.mobilePermissions?.canTrackTime || false,
        canViewTimeEntries:
          collaborator.mobilePermissions?.canViewTimeEntries || false,
        canEditTimeEntries:
          collaborator.mobilePermissions?.canEditTimeEntries || false,
        canViewActivityLogs:
          collaborator.mobilePermissions?.canViewActivityLogs || false,

        // Material & Inventory
        canViewMaterials:
          collaborator.mobilePermissions?.canViewMaterials || false,
        canEditMaterials:
          collaborator.mobilePermissions?.canEditMaterials || false,
        canViewInventory:
          collaborator.mobilePermissions?.canViewInventory || false,
        canUpdateInventory:
          collaborator.mobilePermissions?.canUpdateInventory || false,

        // Communication & Notifications
        canSendNotifications:
          collaborator.mobilePermissions?.canSendNotifications || false,
        canViewMessages:
          collaborator.mobilePermissions?.canViewMessages || false,
        canSendMessages:
          collaborator.mobilePermissions?.canSendMessages || false,
        canViewSystemAlerts:
          collaborator.mobilePermissions?.canViewSystemAlerts || false,
      },
  ...
  const filteredCollaborators =
    collaborators
      ?.filter((collaborator: any) => {
        const matchesSearch =
          (collaborator.fullName || collaborator.name || "")
            .toLowerCase()
          ...
          (collaborator.role || "")
            ...
            .includes(searchTerm.toLowerCase());
        const matchesRole =
          roleFilter === "all" || collaborator.role === roleFilter;
        const matchesStatus =
          statusFilter === "all" ||
  ...
  const getRoleInfo = (role: string) => {
    switch (role) {
      case "admin":
        return {
          label: t("collaborators.roles.admin"),
          color: "bg-red-100 text-red-800",
        };
      case "manager":
        return {
          label: t("collaborators.roles.manager"),
          color: "bg-blue-100 text-blue-800",
        };
      case "worker":
        return {
          label: t("collaborators.roles.worker"),
          color: "bg-green-100 text-green-800",
        };
      case "apprentice":
        return {
          label: t("collaborators.roles.apprentice"),
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Button
              variant="outline"
              onClick={() => setLocation("/admin/artisan-dashboard")}
            >
            ...
            >
              ...
              <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  <DialogTitle>
                    {editingCollaborator
                      ? t("collaborators.editCollaborator")
                      : t("collaborators.newCollaborator")}
                  </DialogTitle>
                  <DialogDescription>
                    {editingCollaborator
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="fullName">
                        {t("collaborators.form.fullName")}
                      </Label>
                      <Input
                        id="fullName"
                        placeholder={t(
                          "collaborators.form.fullNamePlaceholder"
                        )}
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="admin">
                            {t("collaborators.roles.admin")}
                          </SelectItem>
                          <SelectItem value="manager">
                            {t("collaborators.roles.manager")}
                          </SelectItem>
                          <SelectItem value="worker">
                            {t("collaborators.roles.worker")}
                          </SelectItem>
                          <SelectItem value="apprentice">
                            {t("collaborators.roles.apprentice")}
                          </SelectItem>
                        </SelectContent>
                      </Select>
                  ...
                  <div className="border-t pt-4">
                    <Label className="text-lg font-medium">
                      {t("collaborators.mobilePermissions.title")}
                    </Label>
                    <p className="text-sm text-gray-600 mb-4">
                      {t("collaborators.mobilePermissions.description")}
                    </p>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <input
                              ...
                              id="canViewClients"
                              {...form.register(
                                "mobilePermissions.canViewClients"
                              )}
                              className="rounded"
                            />
                            <Label htmlFor="canViewClients" className="text-sm">
                              {t("collaborators.mobilePermissions.view")}
                            </Label>
                            <input
                              type="checkbox"
                              id="canEditClients"
                              {...form.register(
                                "mobilePermissions.canEditClients"
                              )}
                              className="rounded"
                            />
                            <Label htmlFor="canEditClients" className="text-sm">
                              {t("collaborators.mobilePermissions.edit")}
                            </Label>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <input
                              ...
                              id="canViewJobs"
                              {...form.register(
                                "mobilePermissions.canViewJobs"
                              )}
                              className="rounded"
                            />
                            <Label htmlFor="canViewJobs" className="text-sm">
                              {t("collaborators.mobilePermissions.view")}
                            </Label>
                            <input
                              type="checkbox"
                              id="canEditJobs"
                              {...form.register(
                                "mobilePermissions.canEditJobs"
                              )}
                              className="rounded"
                            />
                            <Label htmlFor="canEditJobs" className="text-sm">
                              {t("collaborators.mobilePermissions.edit")}
                            </Label>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <input
                              ...
                              id="canViewReports"
                              {...form.register(
                                "mobilePermissions.canViewReports"
                              )}
                              className="rounded"
                            />
                            ...
                            <input
                              ...
                              id="canCreateReports"
                              {...form.register(
                                "mobilePermissions.canCreateReports"
                              )}
                              className="rounded"
                            />
                            <Label
                              ...
                              className="text-sm"
                            >
                              {t("collaborators.mobilePermissions.create")}
                            </Label>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <input
                              ...
                              id="canViewInvoices"
                              {...form.register(
                                "mobilePermissions.canViewInvoices"
                              )}
                              className="rounded"
                            />
                            <Label
                            ...
                            <input
                              ...
                              id="canEditInvoices"
                              {...form.register(
                                "mobilePermissions.canEditInvoices"
                              )}
                              className="rounded"
                            />
                            <Label
                              htmlFor="canEditInvoices"
                              className="text-sm"
                            >
                              {t("collaborators.mobilePermissions.edit")}
                            </Label>
                  ...
                  <div className="flex justify-end space-x-2 pt-4">
                    ...
                    >
                      ...
                      updateCollaboratorMutation.isPending
                        ? editingCollaborator
                          ? t("collaborators.form.updating")
                          : t("collaborators.form.creating")
          ...
          <CardContent className="p-4">
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <Select value={roleFilter} onValueChange={setRoleFilter}>
                ...
                <SelectContent>
                  <SelectItem value="all">
                    {t("collaborators.filters.allRoles")}
                  </SelectItem>
                  <SelectItem value="admin">
                    {t("collaborators.roles.admin")}
                  </SelectItem>
              ...
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                <SelectTrigger className="w-full md:w-40">
                  <SelectValue
                    placeholder={t("collaborators.filters.status")}
                  />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="all">
                    {t("collaborators.filters.allStatuses")}
                  </SelectItem>
                  <SelectItem value="active">
                    {t("collaborators.filters.active")}
                  </SelectItem>
                  <SelectItem value="inactive">
                    {t("collaborators.filters.inactive")}
                  </SelectItem>
                </SelectContent>
              </Select>
              <Badge variant="outline" className="self-center">
                {filteredCollaborators.length}{" "}
                {t("collaborators.collaboratorsCount")}
              </Badge>
            </div>
          </CardContent>
        </Card>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <Badge
                            variant="outline"
                            className={getRoleInfo(collaborator.role).color}
                          >
                            {getRoleInfo(collaborator.role).label}
                          </Badge>
                          <Badge
                            variant={
                              collaborator.isActive ? "default" : "secondary"
                            }
                          >
                            {collaborator.isActive
                              ? t("collaborators.status.active")
                              : t("collaborators.status.inactive")}
                          </Badge>
                        </div>
                  ...
                  <div className="mt-4 pt-4 border-t">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-sm font-medium text-gray-700">
                        {t("collaborators.mobilePermissions.summary")}
                      </span>
                    </div>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
                      <div className="flex items-center gap-1">
                        ...
                        <Badge variant="outline" className="text-xs">
                          {collaborator.mobilePermissions?.canViewClients
                            ? t("collaborators.mobilePermissions.view")
                            : t("collaborators.mobilePermissions.none")}
                          {collaborator.mobilePermissions?.canEditClients &&
                            ` + ${t("collaborators.mobilePermissions.edit")}`}
                        </Badge>
                      </div>
                      <div className="flex items-center gap-1">
                        ...
                        <Badge variant="outline" className="text-xs">
                          {collaborator.mobilePermissions?.canViewJobs
                            ? t("collaborators.mobilePermissions.view")
                            : t("collaborators.mobilePermissions.none")}
                          {collaborator.mobilePermissions?.canEditJobs &&
                            ` + ${t("collaborators.mobilePermissions.edit")}`}
                        </Badge>
                      </div>
                      <div className="flex items-center gap-1">
                        ...
                        <Badge variant="outline" className="text-xs">
                          {collaborator.mobilePermissions?.canViewReports
                            ? t("collaborators.mobilePermissions.view")
                            : t("collaborators.mobilePermissions.none")}
                          {collaborator.mobilePermissions?.canCreateReports &&
                            ` + ${t("collaborators.mobilePermissions.create")}`}
                        </Badge>
                      </div>
                      <div className="flex items-center gap-1">
                        ...
                        <Badge variant="outline" className="text-xs">
                          {collaborator.mobilePermissions?.canViewInvoices
                            ? t("collaborators.mobilePermissions.view")
                            : t("collaborators.mobilePermissions.none")}
                          {collaborator.mobilePermissions?.canEditInvoices &&
                            ` + ${t("collaborators.mobilePermissions.edit")}`}
                        </Badge>
                      </div>
                    </div>
