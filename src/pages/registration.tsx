...
export default function RegistrationPage() {
  ...
  const textContent = {
    it: {
      ...
      description:
        "Crea un account per accedere a ProjectPro e iniziare a gestire i tuoi progetti",
      ...
      socialSignupComingSoon:
        "La registrazione con {provider} sarà disponibile a breve",
      ...
      emailAlreadyExists:
        "Questa email è già associata ad un account. Effettua il login o utilizza un'altra email.",
    ...
    en: {
      ...
      description:
        "Create an account to access ProjectPro and start managing your projects",
      fullName: "Full Name",
      ...
      socialSignupComingSoon:
        "Registration with {provider} will be available soon",
      ...
      emailAlreadyExists:
        "This email is already associated with an account. Login or use another email.",
  ...
  const currentText =
    textContent[currentLanguage as keyof typeof textContent] || textContent.it;
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 text-sm">
                              <span className="font-medium">
                                €{plan.monthlyPrice}/{currentText.monthly}
                              </span>
                              <span className="font-medium">
                                €{plan.yearlyPrice}/{currentText.yearly}
                              </span>
                            </div>
                          </div>
                          <div className="ml-4">
