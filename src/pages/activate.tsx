...
export default function ActivatePage() {
  ...
  useEffect(() => {
    ...
    if (tokenFromUrl) {
      ...
      setErrorMessage(
        "Token di attivazione mancante. Verifica di aver usato il link corretto."
      );
    }
  }, []);
  ...
  const onSubmit = async (values: ActivationFormValues) => {
    ...
    try {
      ...
      if (response.data) {
        ...
        setErrorMessage(
          data.message ||
            "Si è verificato un errore durante l'attivazione dell'account."
        );
        toast({
          title: "Errore",
          description:
          ...
          <CardContent>
            ...
            {activationStatus === "success" && (
              ...
              >
                ...
                <AlertDescription>
                  <p className="mb-4">
                    Ora puoi accedere all'applicazione con le tue credenziali.
                  </p>
                  <Button
                    onClick={() => navigate("/")}
