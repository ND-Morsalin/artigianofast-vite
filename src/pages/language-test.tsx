    ...
    <div className="container mx-auto py-8 px-4">
      <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      className="w-full p-2 border rounded"
                      placeholder={t("jobs.materialCost")}
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {t("planConfiguration.availableFeaturesDesc")}
                    </p>
                  </div>
                  <div>
                    <h3 className="font-medium mb-2">
                      {t("admin.advancedConfigurations")}
                    </h3>
                    <p className="text-sm text-muted-foreground">
                      {t("planConfiguration.pageAccessDesc")}
                    </p>
                  </div>
                  <div>
                    <h3 className="font-medium mb-2">
                      {t("admin.entityManagement")}
                    </h3>
        ...
        <Card className="mt-8">
          ...
          <CardContent>
            <p className="text-sm">
              <strong>Current Language:</strong> {t("settings.language")} (
              {getCurrentLanguage()})
            </p>
            <p className="text-sm mt-2">
              <strong>Translation Key Example:</strong> {t("jobs.materialCost")}{" "}
              → "{t("jobs.materialCost")}"
            </p>
          </CardContent>
        </Card>
