...
const formSchema = z.object({
  ...
  monthlyPrice: z.coerce
    .number()
    .min(0, { message: "Il prezzo mensile non può essere negativo" }),
  yearlyPrice: z.coerce
    .number()
    .min(0, { message: "Il prezzo annuale non può essere negativo" }),
  monthlyDuration: z.coerce
    .number()
    .min(1, { message: "La durata mensile deve essere di almeno 1 giorno" })
    .optional()
    .nullable(),
  yearlyDuration: z.coerce
    .number()
    .min(1, { message: "La durata annuale deve essere di almeno 1 giorno" })
    .optional()
    .nullable(),
                            ...
                            <TableRow key={plan.id}>
                              ...
                              <TableCell>
                                {plan.monthlyDuration
                                  ? `${plan.monthlyDuration} giorni`
                                  : "Illimitato"}
                              </TableCell>
                              <TableCell>
                                {plan.yearlyDuration
                                  ? `${plan.yearlyDuration} giorni`
                                  : "Illimitato"}
                              </TableCell>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="Essential, Pro, Enterprise..."
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
