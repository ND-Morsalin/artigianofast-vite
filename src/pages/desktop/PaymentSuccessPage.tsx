          ...
          <Card className="shadow-lg border-green-200 bg-white">
            <CardHeader className="text-center pb-2">
              ...
              <CardDescription className="text-base mt-2">
                Grazie per aver scelto ProjectPro. Il tuo abbonamento è ora
                attivo.
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6 pt-4">
                ...
                <div className="flex items-start gap-3 mt-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Abbiamo inviato i dettagli completi dell'ordine a questo
                      indirizzo email.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-green-50 border border-green-100 rounded-lg p-6">
                ...
                <ul className="space-y-3 mt-4">
                  <li className="flex items-start gap-2">
                    <span className="h-5 w-5 rounded-full bg-green-200 text-green-700 flex items-center justify-center text-xs shrink-0 mt-0.5">
                      1
                    </span>
                    <span>
                      Accedi alla piattaforma con le credenziali ricevute via
                      email
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Completa la configurazione del tuo profilo aziendale
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="h-5 w-5 rounded-full bg-green-200 text-green-700 flex items-center justify-center text-xs shrink-0 mt-0.5">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Esplora le guide e i tutorial per sfruttare al meglio la
                      piattaforma
                    </span>
                  </li>
                </ul>
              ...
              <div className="text-center text-sm text-gray-500">
                Per qualsiasi domanda o supporto, contatta il nostro servizio
                clienti all'indirizzo
                <a
                  href="mailto:support@projectpro.it"
                  className="text-primary ml-1"
                >
                  support@projectpro.it
                </a>
              </div>
            </CardContent>
            ...
            <CardFooter className="flex flex-col space-y-3">
              ...
              <Button asChild variant="outline" size="sm">
                <Link href="/desktop">Torna alla Home</Link>
              </Button>
            </CardFooter>
          </Card>
        </div>
