...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route
        path="/desktop/checkout/:planId/:billingType"
        component={DesktopCheckoutPage}
      />
      <Route
        path="/desktop/payment-success"
        component={DesktopPaymentSuccessPage}
      />
      ...
      <Route path="/admin/clients/create" component={ClientsPage} />
      <Route
      ...
      <Route path="/admin/promo-spots">
        {() => {
          const AdminPromoSpotsPage = React.lazy(
            () => import("./admin/AdminPromoSpots")
          );
          return (
      ...
      <Route path="/admin/clients/:id/edit">
        {(params) => {
          const AdminClientEditPage = React.lazy(
            () => import("./pages/admin/clients/[id]/edit")
          );
          return (
            <React.Suspense fallback={<div>Caricamento...</div>}>
      ...
      <Route path="/admin/clients/:id/plan">
        {(params) => {
          const AdminClientPlanPage = React.lazy(
            () => import("./pages/admin/clients/[id]/plan")
          );
          return (
            <React.Suspense fallback={<div>Caricamento...</div>}>
      ...
      <Route
        ...
        component={AdminSettingsClientPlanOverrides}
      />
      ...
      <Route
        path="/admin/settings/web-pages/new"
        component={AdminWebPagesNew}
      />
      ...
      <Route path="/admin/administrators/create">
        {() => {
          const AdminCreatePage = React.lazy(
            () => import("./pages/admin/administrators/create")
          );
          return (
            <React.Suspense fallback={<div>Caricamento...</div>}>
              <AdminCreatePage />
      ...
      <Route path="/admin/administrators/:id/edit">
        {(params) => {
          const AdminEditPage = React.lazy(
            () => import("./pages/admin/administrators/[id]/edit")
          );
          return (
            <React.Suspense fallback={<div>Caricamento...</div>}>
      ...
      <Route path="/admin/administrators/:id/password">
        {(params) => {
          const AdministratorPasswordPage = React.lazy(
            () => import("./pages/admin/administrators/[id]/password")
          );
          return (
            <React.Suspense fallback={<div>Caricamento...</div>}>
      ...
      <Route path="/admin/forgot-password">
        {() => {
          const ForgotPasswordPage = React.lazy(
            () => import("./pages/admin/forgot-password")
          );
          return (
            <React.Suspense fallback={<div>Caricamento...</div>}>
              <ForgotPasswordPage />
