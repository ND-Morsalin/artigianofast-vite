      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600 max-w-3xl mx-auto">
            ProjectPro è la piattaforma completa per gestire clienti,
            collaboratori e progetti. Ottimizza i tuoi processi, aumenta la
            produttività e cresci il tuo business.
          </p>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <CardContent className="p-6">
              ...
              <p className="text-gray-600">
                Organizza i tuoi clienti, traccia le comunicazioni e gestisci i
                rapporti in modo professionale.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <CardContent className="p-6">
              ...
              <p className="text-gray-600">
                Crea e gestisci progetti con calendario integrato, assegnazione
                attività e tracking progressi.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <CardContent className="p-6">
              ...
              <p className="text-gray-600">
                Monitora le performance, analizza i dati e prendi decisioni
                informate per crescere il business.
              </p>
            </CardContent>
          </Card>
        </div>
