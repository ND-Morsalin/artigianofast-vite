...
const plans: PricingPlan[] = [
  ...
  },
  {
    ...
    limitations: ["Senza funzionalità enterprise", "Limite utenti"],
    popular: true,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            Scegli il piano perfetto per le tue esigenze. Tutti i piani
            includono aggiornamenti gratuiti e supporto tecnico.
          </p>
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <CardHeader className="text-center pb-8">
                <div
                  className={`w-12 h-12 rounded-lg flex items-center justify-center mx-auto mb-4 ${getIconColorClasses(
                    plan.color
                  )}`}
                >
                  {plan.icon}
              ...
              <CardContent className="pt-0">
                ...
                {plan.limitations.length > 0 && (
                  <div className="space-y-4 mb-8">
                    ...
                    {plan.limitations.map((limitation, index) => (
                      <div key={index} className="flex items-start">
                        <X className="w-5 h-5 text-gray-400 mr-3 mt-0.5 shrink-0" />
                ...
                <p className="text-xs text-gray-500 text-center mt-3">
                  Prova gratuita di 14 giorni • Nessuna carta di credito
                  richiesta
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="text-left">
              ...
              <p className="text-gray-600">
                Sì, puoi aggiornare o declassare il tuo piano in qualsiasi
                momento. Le modifiche vengono applicate immediatamente.
              </p>
            </div>
            <div className="text-left">
              <h4 className="font-semibold text-gray-900 mb-2">
              ...
              <p className="text-gray-600">
                No, tutti i piani includono progetti illimitati. I limiti si
                applicano solo al numero di utenti.
              </p>
            </div>
            <div className="text-left">
              <h4 className="font-semibold text-gray-900 mb-2">
              ...
              <p className="text-gray-600">
                Assolutamente. Utilizziamo crittografia end-to-end e backup
                automatici per garantire la sicurezza dei tuoi dati.
              </p>
            </div>
            <div className="text-left">
              <h4 className="font-semibold text-gray-900 mb-2">
              ...
              <p className="text-gray-600">
                Sì, tutti i piani includono supporto tecnico. I piani
                Professional ed Enterprise includono supporto prioritario.
              </p>
            </div>
          </div>
        </div>
