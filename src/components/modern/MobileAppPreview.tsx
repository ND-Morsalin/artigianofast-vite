          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                L'app ProjectPro ti permette di gestire clienti, progetti e
                attività direttamente dal tuo smartphone. Sincronizzazione
                automatica e interfaccia ottimizzata per mobile.
              </p>
            </div>
