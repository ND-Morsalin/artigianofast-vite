...
// Pie Chart Component
export const PlanDistributionPieChart: React.FC<{ data: ChartData[] }> = ({
  data,
}) => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>
          {t("analytics.charts.planDistribution", "Plan Distribution")}
        </CardTitle>
        <CardDescription>
          {t(
            "analytics.charts.planDistributionDesc",
...
export const RevenueBarChart: React.FC<{ data: ChartData[] }> = ({ data }) => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>
          {t("analytics.charts.revenueBreakdown", "Revenue Breakdown")}
        </CardTitle>
        <CardDescription>
          {t(
            "analytics.charts.revenueBreakdownDesc",
            "Monthly and yearly revenue by plan"
          )}
        </CardDescription>
      </CardHeader>
      <CardContent>
        <ResponsiveContainer width="100%" height={300}>
          ...
          >
            ...
            <Bar
              ...
              fill="#8884d8"
              name={t("analytics.charts.monthly", "Monthly")}
            />
            <Bar
              dataKey="yearlyRevenue"
              fill="#82ca9d"
              name={t("analytics.charts.yearly", "Yearly")}
            />
          </BarChart>
        </ResponsiveContainer>
      </CardContent>
...
export const UserGrowthLineChart: React.FC<{ data: ChartData[] }> = ({
  data,
}) => {
  const { t } = useTranslation();
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>
          {t("analytics.charts.userGrowth", "User Growth Trend")}
        </CardTitle>
        <CardDescription>
          {t(
            "analytics.charts.userGrowthDesc",
...
export const FeatureUsageAreaChart: React.FC<{ data: ChartData[] }> = ({
  data,
}) => {
  const { t } = useTranslation();
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>
          {t("analytics.charts.featureUsage", "Feature Usage Trends")}
        </CardTitle>
        <CardDescription>
          {t(
            "analytics.charts.featureUsageDesc",
            "Most used features over time"
          )}
        </CardDescription>
      </CardHeader>
      <CardContent>
        <ResponsiveContainer width="100%" height={300}>
          ...
          >
            ...
            <Area
              ...
              fill="#ffc658"
              name={t(
                "analytics.charts.collaboratorManagement",
...
export const SystemPerformanceComposedChart: React.FC<{
  data: ChartData[];
}> = ({ data }) => {
  const { t } = useTranslation();
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>
          {t("analytics.charts.systemPerformance", "System Performance")}
        </CardTitle>
        <CardDescription>
          {t(
            "analytics.charts.systemPerformanceDesc",
        ...
        <ResponsiveContainer width="100%" height={300}>
          ...
          >
            ...
            <Bar
              ...
              dataKey="requests"
              fill="#8884d8"
              name={t("analytics.charts.requests", "Requests")}
            />
            <Line
              yAxisId="right"
              type="monotone"
              ...
              stroke="#ff7300"
              name={t("analytics.charts.responseTime", "Response Time (ms)")}
            />
          </ComposedChart>
        </ResponsiveContainer>
      </CardContent>
...
export const FeatureAdoptionRadarChart: React.FC<{ data: ChartData[] }> = ({
  data,
}) => {
  const { t } = useTranslation();
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>
          {t("analytics.charts.featureAdoption", "Feature Adoption Radar")}
        </CardTitle>
        <CardDescription>
          {t(
            "analytics.charts.featureAdoptionDesc",
            "Adoption rates for different features"
          )}
        </CardDescription>
      </CardHeader>
      <CardContent>
...
export const UserEngagementScatterChart: React.FC<{ data: ChartData[] }> = ({
  data,
}) => {
  const { t } = useTranslation();
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>
          {t("analytics.charts.userEngagement", "User Engagement Analysis")}
        </CardTitle>
        <CardDescription>
          {t(
            "analytics.charts.userEngagementDesc",
            "User engagement vs. feature usage correlation"
          )}
        </CardDescription>
      </CardHeader>
      <CardContent>
        <ResponsiveContainer width="100%" height={300}>
          <ScatterChart margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
            ...
            <XAxis
              ...
              name={t("analytics.charts.sessionDuration", "Session Duration")}
            />
            <YAxis
              type="number"
              dataKey="featuresUsed"
              name={t("analytics.charts.featuresUsed", "Features Used")}
            />
            <ZAxis
              type="number"
              dataKey="userRating"
              range={[60, 400]}
              name={t("analytics.charts.userRating", "User Rating")}
            />
            <Tooltip cursor={{ strokeDasharray: "3 3" }} />
            <Legend />
            <Scatter
              name={t("analytics.charts.users", "Users")}
              data={data}
              fill="#8884d8"
            />
          </ScatterChart>
  ...
  return (
    <div className="space-y-6">
      ...
      <MetricsCards
        metrics={{
          totalRevenue: revenueData.reduce(
            (sum, item) =>
              sum + (item.monthlyRevenue || 0) + (item.yearlyRevenue || 0),
            0
          ),
          activeUsers:
      ...
      <div className="grid grid-cols-1 gap-6">
        <UserEngagementScatterChart
          data={userGrowthData.map((item, idx) => ({
            name: item.name || `user-${idx}`,
