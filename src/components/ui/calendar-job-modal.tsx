...
const jobSchema = z.object({
  ...
  clientId: z.number("Il cliente è richiesto"),
  type: z.enum(
    ["repair", "installation", "maintenance", "quote", "emergency"] as const,
    {
      message: "Il tipo di lavoro è richiesto",
    }
  ),
  ...
  materialsCost: z.number("La durata è richiesta").default(0).optional(),
...
export function CalendarJobModal({
  isOpen,
  onClose,
  selectedDate,
  onJobAdded,
}: CalendarJobModalProps) {
