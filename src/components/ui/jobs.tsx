...
export function Jobs({ isRegistrationMode = false }: JobsProps) {
  ...
  const [statusFilter, setStatusFilter] = useState(
    isRegistrationMode ? "in_progress" : "all"
  ); // Mostriamo di default tutti i lavori
  ...
  console.log("Activities fetched:", activitiesLoading);
  ...
  const formatDateTime = (dateString: string, duration: number) => {
    ...
    return `${format(date, "d MMMM, yyyy", { locale: it })} • ${format(
      date,
      "HH:mm"
  ...
  const calculateTotalPrice = (job: Job) => {
    ...
    return totalCost.toLocaleString("it-IT", {
          ...
          <button
            ...
            onClick={() =>
              document.dispatchEvent(
                new CustomEvent("openModal", { detail: "new-job-modal" })
              )
            }
          >
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                Seleziona un lavoro per registrare le attività completate, i
                materiali utilizzati, e compilare i dettagli necessari per la
                fatturazione.
              </p>
            </div>
          </div>
            ...
            >
              ...
              {activities
                .filter(
                  (a) =>
                    typeFilter === "all" ||
                    a.jobTypeId.toString() === typeFilter ||
                    (a.jobTypeIds && a.jobTypeIds.includes(typeFilter))
                )
                .map((activity) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span>
                    €{calculateTotalPrice(job)} • Materiali: €
                    {job.materialsCost.toLocaleString("it-IT", {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
                  </span>
              ...
              <div className="bg-neutral-50 p-3 border-t border-neutral-200 flex justify-end space-x-2">
                ...
                {isRegistrationMode ? (
                  <JobActivityRegistration
                    job={{
                      ...job,
                      client: { name: getClientName(job.clientId) },
                    }}
                    onCompleted={() => {
