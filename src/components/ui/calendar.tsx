...
export function Calendar() {
  const { calendarView, setCalendarView, currentDate, setCurrentDate } =
    useCalendar();
  ...
  const formatDisplayDate = () => {
    if (calendarView === "month") {
      ...
      if (isSameMonth(weekStart, weekEnd)) {
        ...
        return `${format(weekStart, "d MMMM", { locale: it })} - ${format(
          weekEnd,
          "d MMMM yyyy",
          { locale: it }
        )}`;
            ...
            <>
              <DialogHeader>
                <DialogTitle className="flex justify-between items-center">
                  ...
                  <span
                    className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getJobColor(
                      selectedJob.type
                    )}`}
                  >
                ...
                <DialogDescription>
                  {formatFullDate(new Date(selectedJob.startDate))} alle{" "}
                  {formatTime(new Date(selectedJob.startDate))}
                </DialogDescription>
              </DialogHeader>
                ...
                <div className="grid grid-cols-2 gap-4 items-center">
                  <div>
                    ...
                    <p className="text-sm">
                      ...
                      {selectedJob.duration === 1 ? "ora" : "ore"}
                    </p>
                  </div>
                  <div>
                  ...
                  jobsWithClients
                    ...
                    .map((job) => {
                      ...
                      const endTime = new Date(
                        startTime.getTime() + job.duration * 60 * 60 * 1000
                      );
                          ...
                          <div className="relative z-10">
                            <div className="flex justify-between items-center mb-2">
                              ...
                              <div className="flex items-center space-x-2">
                                <span
                                  className={`text-xs ${getJobColor(
                                    job.type
                                  )} text-white px-2 py-1 rounded`}
                                >
                                  {job.duration}{" "}
                                  {job.duration === 1 ? "ora" : "ore"}
                                </span>
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        ...
                        isCurrentDay ? "bg-blue-600 bg-opacity-5" : "",
                        dayIndex >= 35 && !dayJobs.length && !isCurrentDay
                          ? "border-b-0"
                          : "",
                        dayIndex % 7 === 6 ? "border-r-0" : "",
                        dayIndex >= 35 && dayIndex < 42 && !isCurrentMonth
                          ? "hidden"
                          : ""
                      )}
                      onClick={() => handleAddJob(day)}
                      ...
                      {dayJobs
                        ...
                        .map((job) => (
                          <div
                            ...
                            className={`${getJobColor(
                              job.type
                            )} text-white text-xs p-1 rounded truncate mb-1`}
                            onClick={(e) => {
                              e.stopPropagation();
                              handleViewJob(job);
                            }}
