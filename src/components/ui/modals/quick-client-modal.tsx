...
const clientSchema = z.object({
  ...
  type: z.enum(["residential", "commercial", "industrial"] as const, {
    message: "Il tipo di cliente è richiesto",
  }),
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Inserisci le coordinate nel formato "latitudine,longitudine"
                    o usa il pulsante per ottenere la posizione attuale
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
