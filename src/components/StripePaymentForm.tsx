...
const stripePromise = loadStripe(
  "pk_test_51SLOsz0tBEbSl2OOitSdeD3U8EP4DVNpaH4pMni7SwgsOrBji4KmUpxn7URadVr26Y86JjH1PEIeytDNC0AYb5M500X0lliBsR"
);
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (pmError) {
        ...
        onError(
          pmError.message || "Errore nella creazione del metodo di pagamento"
        );
        setIsProcessing(false);
        return;
      }
